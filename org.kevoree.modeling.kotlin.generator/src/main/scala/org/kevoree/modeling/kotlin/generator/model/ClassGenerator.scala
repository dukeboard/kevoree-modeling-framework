    ...
    atts.foreach {
      ...
      //Generate getter
        ...
        if (att.isID()) {
          ...
          pr.println("previousParent.reflexiveMutator(\"remove\",previousRefNameInParent!!,this);")
          pr.println("}")
        }
        ...
        if (att.isID()) {
          pr.println("if(previousParent!=null){")
          pr.println("previousParent.reflexiveMutator(\"add\",previousRefNameInParent!!,this);")
          pr.println("}")
        }
