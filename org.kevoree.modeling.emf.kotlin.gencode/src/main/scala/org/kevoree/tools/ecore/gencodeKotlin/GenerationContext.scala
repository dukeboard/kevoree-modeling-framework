 ...
 * 	Nain Gregory
 */
package org.kevoree.tools.ecore.gencodeKotlin
...
class GenerationContext {
  ...
  def setPackagePrefix(pack : Option[String]) {packagePrefix = pack}
  ...
  def setRootGenerationDirectory(dir : File) {rootGenerationDirectory=dir}
  ...
  def setRootContainerClassName(className : Option[String]) {rootXmiContainerClassName = className}
