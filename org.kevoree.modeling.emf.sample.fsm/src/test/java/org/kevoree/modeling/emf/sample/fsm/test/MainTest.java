...
public class MainTest {
    ...
    public void flatFsmTest(PrintWriter statPr,int STATES) throws IOException {
       ...
       State s0 = initial;
        ...
        System.out.println("===== END DEEP :" + STATES + "=====");
        System.out.println("");
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        File f = File.createTempFile("KMF_FLAT_FSM_TEST-" + System.currentTimeMillis(),".csv");
        PrintWriter pr = new PrintWriter(f);
        pr.println("Deep;Memory;States;Creation;Marshaling;Loading");
        int step = 35000;
       ...
       /* File f = File.createTempFile("KMF_BINARY_FSM_TEST-" + System.currentTimeMillis(),".csv");
        PrintWriter pr = new PrintWriter(f);
        pr.println("Deep;Memory;States;Creation;Marshaling;Loading");
        for(int i = 1 ; Math.pow(2,i)<600000;i++) {
            m.binaryFsmTest(pr,i);
        }
        pr.flush();
        pr.close();
