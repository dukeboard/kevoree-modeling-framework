...
// occurs on primitive string objects.
        ...
        function memberLookup(obj, val) {
            ...
            if (typeof obj[val] === 'function') {
                ...
                if (obj.metaClass !== undefined && obj.metaClass !== null) {
                    if (runtime.ctx.ctx.managedObjects !== undefined && runtime.ctx.ctx.managedObjects !== null) {
                        runtime.ctx.ctx.managedObjects[obj.uuid()] = obj;
                    }
                    var metaElem = obj.metaClass().attribute(val);
                    if (metaElem !== undefined && metaElem !== null) {
                        return obj.get(metaElem);
                    } else {
        ...
        function asyncEach(arr, dimen, iter, cb) {
            if (arr !== undefined && arr !== null && arr.defer != undefined && arr.arr !== undefined) {
                arr.defer.then(function (resolved) {
                    ...
                    lib.asyncIter(resolved, function (item, i, next) {
                        switch (dimen) {
                            case 1:
                ...
                if (this.is_finished()) {
                    ...
                    while ((data = this._extractUntil(beginChars)) !== null) {
                        ...
                        if ((this._matches(this.tags.BLOCK_START) ||
                            ...
                            this._matches(this.tags.COMMENT_START)) && !in_comment) {
                ...
                if (ctx.autoRefresh) {
                    ...
                    ctx.managedListener = function (srcEvent, metaEvt) {
                        ...
                        if (ctx.autoNow) {
                            ...
                            if (originUniverse !== undefined) {
                                originUniverse.time((new Date()).getTime()).lookupAll(toReloadIds).then(function (reloadedObjs) {
                                    try {
                                        for (var reloadedObjKey in reloadedObjs) {
                                            var reloadedObj = reloadedObjs[reloadedObjKey];
                                            if (reloadedObj !== undefined && reloadedObj !== null) {
                                                var previousName = toReloadMap[reloadedObj.uuid()];
                                                ctx[previousName] = reloadedObj;
                                            }
                                        }
                                    } catch (e) {
                                        console.error(e);
