 ...
 */
package org.kevoree.modeling.emf.kotlin.gencode.mavenplugin;
...
import org.kevoree.tools.ecore.kotlin.gencode.persistent.GeneratePersistentAspectedClasses;
 ...
 * @version $Id$
 * @goal generatePersistentLayer
 * @phase generate-sources
 * @requiresDependencyResolution compile
 */
public class GenPersistentModelPlugin extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException {
        ...
        gen.generatePLayer(ecore, project.getVersion());
