...
public final class ObjectExplorer {
   ...
   * In particular:
   * <ul>
   * <li>If {@link com.google.caliper.memory.ObjectExplorer.Feature#VISIT_PRIMITIVES} is contained in features,
   * the visitor will also be notified about exploration of primitive values.
   * <li>If {@link com.google.caliper.memory.ObjectExplorer.Feature#VISIT_NULL} is contained in features, the visitor
   * will also be notified about exploration of {@code null} values.
   * </ul>
   * In both cases above, the return value of
   * {@link ObjectVisitor#visit(com.google.caliper.memory.Chain)} is ignored, since neither primitive
   ...
   * traversal.
   *
   * @see com.google.caliper.memory.ObjectExplorer#exploreObject(Object, ObjectVisitor, java.util.EnumSet)
   */
  public enum Feature {
    /**
