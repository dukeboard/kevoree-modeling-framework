 ...
 */
trait AdaptationPrimitiveTypeInternal : org.kevoree.container.KMFContainerImpl, org.kevoree.AdaptationPrimitiveType , org.kevoree.impl.NamedElementInternal {
...
if(mutableOnly && isRecursiveReadOnly()){return}
		val selfObjectClone = _factories.getKevoreeFactory().createAdaptationPrimitiveType()
...
val clonedSelfObject = addrs.get(this) as org.kevoree.impl.AdaptationPrimitiveTypeInternal
