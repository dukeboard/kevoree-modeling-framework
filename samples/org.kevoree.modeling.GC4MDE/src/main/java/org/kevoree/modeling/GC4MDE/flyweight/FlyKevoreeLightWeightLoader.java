 ...
 * Time: 23:29
 */
public class FlyKevoreeLightWeightLoader {

    public static void main(String[] args){

        String content = buildTestRes();
        XMIModelLoader loader = new XMIModelLoader();
        FlyweightKevoreeFactory flyWF = new FlyweightKevoreeFactory();
        loader.setKevoreeFactory(flyWF);
        ...
        for (int i = 0; i < 25000; i++) {
            ...
            for(ContainerRoot model : models){
                flyWF.restack(model);
            }
        }
