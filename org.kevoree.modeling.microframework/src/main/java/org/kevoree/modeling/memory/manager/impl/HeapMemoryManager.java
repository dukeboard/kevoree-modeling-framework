...
public class HeapMemoryManager implements KMemoryManager {
    ...
    public ArrayLongLongHashMap globalUniverseOrder() {
        return (ArrayLongLongHashMap) _cache.get(KConfig.NULL_LONG, KConfig.NULL_LONG, KConfig.NULL_LONG);
    }
    ...
    public long[] descendantsUniverseKeys(final long currentUniverseKey) {
        ArrayLongLongHashMap cached = globalUniverseOrder();
        if (cached != null) {
            final ArrayLongLongHashMap temp = new ArrayLongLongHashMap(KConfig.CACHE_INIT_SIZE, KConfig.CACHE_LOAD_FACTOR);
            cached.each(new KLongLongHashMapCallBack() {
                @Override
            ...
            temp.each(new KLongLongHashMapCallBack() {
                @Override
                public void on(long key, long value) {
    ...
    public void initKObject(KObject obj) {
        ...
        ArrayLongLongHashMap universeTree = new ArrayLongLongHashMap(KConfig.CACHE_INIT_SIZE, KConfig.CACHE_LOAD_FACTOR);
        universeTree.inc();
                                ...
                                new KThrowableCallback<Short>() {
                                    ...
                                    public void on(Short newPrefix, Throwable error) {
                                        if (error != null) {
                                            ...
                                            _db.get(connectionElemKeys, new KThrowableCallback<String[]>() {
                                                @Override
                                                    ...
                                                    if (errorL2 != null) {
                                                        ...
                                                        if (strings.length == 3) {
                                                            ...
                                                            try {
                                                                ...
                                                                ArrayLongLongHashMap globalUniverseTree;
                                                                if (globalUniverseTreePayload != null) {
                                                                    ...
                                                                    globalUniverseTree = new ArrayLongLongHashMap(KConfig.CACHE_INIT_SIZE, KConfig.CACHE_LOAD_FACTOR);
                                                                }
        ...
        bumpKeyToCache(KContentKey.createRootUniverseTree(), new KCallback<KMemoryElement>() {
            ...
            public void on(KMemoryElement rootGlobalUniverseIndex) {
                if (rootGlobalUniverseIndex == null) {
                    ...
                    long closestUniverse = ResolutionHelper.resolve_universe(globalUniverseOrder(), (ArrayLongLongHashMap) rootGlobalUniverseIndex, time, universe);
    ...
    public void setRoot(final KObject newRoot, final KCallback<Throwable> callback) {
        bumpKeyToCache(KContentKey.createRootUniverseTree(), new KCallback<KMemoryElement>() {
            ...
            public void on(KMemoryElement globalRootTree) {
                ArrayLongLongHashMap cleanedTree = (ArrayLongLongHashMap) globalRootTree;
                if (cleanedTree == null) {
                    cleanedTree = new ArrayLongLongHashMap(KConfig.CACHE_INIT_SIZE, KConfig.CACHE_LOAD_FACTOR);
    ...
    public void reload(KContentKey[] keys, final KCallback<Throwable> callback) {
        ...
        _db.get(toReload_flat, new KThrowableCallback<String[]>() {
            @Override
    ...
    public void bumpKeyToCache(final KContentKey contentKey, final KCallback<KMemoryElement> callback) {
        ...
        if (cached != null) {
            ...
            keys[0] = contentKey;
            _db.get(keys, new KThrowableCallback<String[]>() {
                @Override
                public void on(String[] strings, Throwable error) {
                    if (strings[0] != null) {
    ...
    public void bumpKeysToCache(KContentKey[] contentKeys, final KCallback<KMemoryElement[]> callback) {
        ...
        if (toLoadIndexes == null) {
            ...
            _db.get(toLoadDbKeys, new KThrowableCallback<String[]>() {
                @Override
    ...
    private KMemoryElement internal_unserialize(KContentKey key, String payload) {
        ...
        if (KConfig.END_OF_TIME == key.obj) {
            if (isUniverseNotNull) {
                ...
                result = new ArrayLongLongHashMap(0, KConfig.CACHE_LOAD_FACTOR);
            }
        } else {
