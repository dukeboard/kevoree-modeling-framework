                ...
                (function (_event) {
                    ...
                    var DefaultKEvent = (function () {
                        function DefaultKEvent(p_type, p_meta, p_source, p_pastValue, p_newValue) {
                            ...
                            this._kActionTypeIndex = p_type.ordinal();
                            this._metaClassIndex = p_source.metaClass().index();
                            if (p_meta != null) {
                                this._metaElementIndex = p_meta.index();
                            } else {
                                this._metaElementIndex = -1;
                            }
                            if (p_pastValue != null) {
                                this._pastValue = p_pastValue.toString();
                            }
                            if (p_newValue != null) {
                                this._newValue = p_newValue.toString();
                            }
                        }
                        ...
                        DefaultKEvent.prototype.toJSON = function () {
                            ...
                            sb.append(DefaultKEvent.DIMENSION_KEY).append(":").append(this._dimensionKey).append(",");
                            sb.append(DefaultKEvent.TIME_KEY).append(":").append(this._time).append(",");
                            sb.append(DefaultKEvent.UUID_KEY).append(":").append(this._uuid).append(",");
                            sb.append(DefaultKEvent.TYPE_KEY).append(":").append(this._kActionTypeIndex).append(",");
                            sb.append(DefaultKEvent.CLASS_KEY).append(":").append(this._metaClassIndex).append(",");
                            sb.append(DefaultKEvent.ELEMENT_KEY).append(":").append(this._metaElementIndex);
                            if (this._pastValue != null) {
                                sb.append(",").append(DefaultKEvent.PAST_VALUE_KEY).append(":").append(this._pastValue);
                            }
                            if (this._newValue != null) {
                                sb.append(",").append(DefaultKEvent.NEW_VALUE_KEY).append(":").append(this._newValue);
                            }
                        ...
                        DefaultKEvent.fromJSON = function (payload) {
                            ...
                            if (currentToken.tokenType() == org.kevoree.modeling.api.json.Type.LEFT_BRACKET) {
                                ...
                                var event = new org.kevoree.modeling.api.event.DefaultKEvent();
                        ...
                        DefaultKEvent.TYPE_KEY = "typeIdx";
                        DefaultKEvent.CLASS_KEY = "classIdx";
                        DefaultKEvent.ELEMENT_KEY = "elemIdx";
                        DefaultKEvent.PAST_VALUE_KEY = "pastValue";
                        DefaultKEvent.NEW_VALUE_KEY = "newValue";
