...
(function (geometry) {
    ...
    (function (impl) {
        var GeometryViewImpl = (function (_super) {
            ...
            GeometryViewImpl.prototype.internalCreate = function (p_clazz, p_universeTree, p_key) {
                if (p_clazz == null) {
                    return null;
                }
                switch (p_clazz.index()) {
                    case 1:
                        return new geometry.impl.ShapeImpl(this, p_key, p_universeTree, p_clazz);
                    case 0:
                        return new geometry.impl.LibraryImpl(this, p_key, p_universeTree, p_clazz);
                    default:
        ...
        var LibraryImpl = (function (_super) {
            ...
            function LibraryImpl(p_factory, p_uuid, p_universeTree, p_metaClass) {
        ...
        var ShapeImpl = (function (_super) {
            ...
            function ShapeImpl(p_factory, p_uuid, p_universeTree, p_metaClass) {
                _super.call(this, p_factory, p_uuid, p_universeTree, p_metaClass);
            }
    ...
    (function (meta) {
        ...
        var MetaShape = (function (_super) {
            ...
            MetaShape.ATT_COLOR = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("color", 4, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
            MetaShape.ATT_NAME = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("name", 5, 0, true, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
            return MetaShape;
        })(org.kevoree.modeling.api.abs.AbstractMetaClass);
