            ...
            (function (api) {
                ...
                (function (abs) {
                    ...
                    var AbstractKObject = (function () {
                        ...
                        AbstractKObject.prototype.jump2 = function (time, p_callback) {
                            var keys = new Array();
                            keys[0] = this.uuid();
                ...
                (function (data) {
                    ...
                    (function (cache) {
                        var HashMemoryCache = (function () {
                            ...
                            HashMemoryCache.prototype.hashKey = function (p_key) {
                                return (p_key.universe ^ p_key.time ^ p_key.obj);
                            };
                            ...
                            HashMemoryCache.prototype.put = function (universe, time, obj, payload) {
                                ...
                                if (entry == null) {
                                    ...
                                    entry = new org.kevoree.modeling.api.data.cache.HashMemoryCache.Entry();
                            ...
                            HashMemoryCache.prototype.computeMaxSize = function () {
                                this.threshold = (this.elementDataSize * this.loadFactor);
                            };
                            HashMemoryCache.prototype.rehashCapacity = function (capacity) {
                                var length = (capacity == 0 ? 1 : capacity << 1);
                                var newData = new Array();
                                for (var i = 0; i < this.elementDataSize; i++) {
                                    var entry = this.elementData[i];
                                    while (entry != null) {
                                        var index = ((entry.universe ^ entry.time ^ entry.obj) & 0x7FFFFFFF) % length;
                                        var next = entry.next;
                    ...
                    (function (manager) {
                        ...
                        var DefaultKDataManager = (function () {
                            ...
                            DefaultKDataManager.prototype.initKObject = function (obj, originView) {
                                ...
                                this._cache.put(obj.universe().key(), org.kevoree.modeling.api.KConfig.NULL_LONG, obj.uuid(), timeTree);
                                ...
                                this._cache.put(obj.universe().key(), obj.now(), obj.uuid(), cacheEntry);
                            };
                            ...
                            DefaultKDataManager.prototype.entry = function (origin, accessMode) {
                                ...
                                if (resolvedNode != null) {
                                    ...
                                    if (!needTimeCopy && !needUniverseCopy) {
                                        ...
                                        this._cache.put(origin.universe().key(), origin.now(), origin.uuid(), clonedEntry);
                                        if (!needUniverseCopy) {
                                            ...
                                            this._cache.put(origin.universe().key(), org.kevoree.modeling.api.KConfig.NULL_LONG, origin.uuid(), newTemporalTree);
                    ...
                    var IndexRBTree = (function () {
                        function IndexRBTree() {
                            ...
                            for (var i = 0; i < org.kevoree.modeling.api.KConfig.TREE_CACHE_SIZE; i++) {
                                this._previousOrEqualsCacheKeys[i] = org.kevoree.modeling.api.KConfig.NULL_LONG;
                            }
                        ...
                        IndexRBTree.prototype.tryPreviousOrEqualsCache = function (key) {
                            if (this._previousOrEqualsCacheKeys != null && this._previousOrEqualsCacheValues != null) {
                                for (var i = 0; i < this._nextCacheElem; i++) {
                                    if (this._previousOrEqualsCacheKeys[i] != org.kevoree.modeling.api.KConfig.NULL_LONG && key == this._previousOrEqualsCacheKeys[i]) {
                ...
                (function (util) {
                    ...
                    var DefaultOperationManager = (function () {
                        ...
                        DefaultOperationManager.prototype.sendToRemote = function (source, operation, param, callback) {
                            ...
                            var contentKey = new org.kevoree.modeling.api.data.cache.KContentKey(source.universe().key(), source.now(), source.uuid());
...
(function (cloud) {
    var CloudModel = (function (_super) {
        ...
        CloudModel.prototype.internal_create = function (key) {
            return new cloud.CloudUniverse(this, key);
        };
    ...
    var CloudUniverse = (function (_super) {
        ...
        function CloudUniverse(p_model, key) {
    ...
    (function (impl) {
        var CloudViewImpl = (function (_super) {
            ...
            function CloudViewImpl(p_now, p_universe) {
                _super.call(this, p_now, p_universe);
            }
            CloudViewImpl.prototype.internalCreate = function (p_clazz, p_key) {
                if (p_clazz == null) {
                    return null;
                }
                switch (p_clazz.index()) {
                    case 1:
                        return new cloud.impl.ElementImpl(this, p_key, p_clazz);
                    case 0:
                        return new cloud.impl.NodeImpl(this, p_key, p_clazz);
                    default:
            ...
            CloudViewImpl.prototype.universe = function () {
        ...
        var ElementImpl = (function (_super) {
            ...
            function ElementImpl(p_factory, p_uuid, p_metaClass) {
            ...
            ElementImpl.prototype.trigger = function (p_param, p_loop, p_result) {
                ...
                this.view().universe().model().manager().operationManager().call(this, cloud.meta.MetaElement.OP_TRIGGER, trigger_params, function (o) {
                    p_result(o);
                });
            };
        ...
        var NodeImpl = (function (_super) {
            ...
            function NodeImpl(p_factory, p_uuid, p_metaClass) {
                _super.call(this, p_factory, p_uuid, p_metaClass);
            }
            ...
            NodeImpl.prototype.getElement = function () {
                var task = new org.kevoree.modeling.api.abs.AbstractKDeferWrapper();
    ...
    (function (meta) {
        var MetaElement = (function (_super) {
            ...
            function MetaElement() {
                ...
                temp_all[3] = MetaElement.OP_TRIGGER;
                this.init(temp_all);
            }
            ...
            MetaElement.ATT_LOAD = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("load", 4, 2.2, false, org.kevoree.modeling.api.meta.PrimitiveTypes.DOUBLE, org.kevoree.modeling.api.extrapolation.PolynomialExtrapolation.instance());
            MetaElement.ATT_NAME = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("name", 5, 0, true, org.kevoree.modeling.api.meta.PrimitiveTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
            MetaElement.ATT_VALUE = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("value", 6, 0, false, org.kevoree.modeling.api.meta.PrimitiveTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
            MetaElement.OP_TRIGGER = new org.kevoree.modeling.api.abs.AbstractMetaOperation("trigger", 7, function () {
        ...
        var MetaNode = (function (_super) {
            ...
            function MetaNode() {
                ...
                temp_all[3] = MetaNode.REF_ELEMENT;
                var temp_operations = new Array();
                this.init(temp_all);
            }
            ...
            MetaNode.ATT_NAME = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("name", 4, 0, true, org.kevoree.modeling.api.meta.PrimitiveTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
            MetaNode.ATT_VALUE = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("value", 5, 0, false, org.kevoree.modeling.api.meta.PrimitiveTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
            MetaNode.REF_CHILDREN = new org.kevoree.modeling.api.abs.AbstractMetaReference("children", 6, true, false, function () {
                return cloud.meta.MetaNode.getInstance();
            }, null, function () {
                return cloud.meta.MetaNode.getInstance();
            });
            MetaNode.REF_ELEMENT = new org.kevoree.modeling.api.abs.AbstractMetaReference("element", 7, true, true, function () {
                return cloud.meta.MetaElement.getInstance();
            }, null, function () {
                return cloud.meta.MetaNode.getInstance();
            });
