        ...
        (function (modeling) {
            ...
            (function (api) {
                    ...
                    var AbstractKObject = (function () {
                        ...
                        AbstractKObject.prototype.select = function (query, callback) {
                            ...
                            if (this.isRoot()) {
                                var roots = new Array();
                                roots[0] = this;
                                org.kevoree.modeling.api.traversal.KSelector.select(this.view(), roots, cleanedQuery, callback);
                            }
                            else {
                                if (query.startsWith("/")) {
                                    ...
                                    this.universe().model().storage().getRoot(this.view(), function (rootObj) {
                                        if (rootObj == null) {
                                            ...
                                            var roots = new Array();
                                            roots[0] = rootObj;
                                            org.kevoree.modeling.api.traversal.KSelector.select(rootObj.view(), roots, finalCleanedQuery, callback);
                                        }
                                    });
                                }
                                else {
                                    var roots = new Array();
                                    roots[0] = this;
                                    org.kevoree.modeling.api.traversal.KSelector.select(this.view(), roots, query, callback);
                                }
                            }
                        };
                            ...
                            this.universe().model().storage().getRoot(this, function (rootObj) {
                                if (rootObj == null) {
                                    ...
                                    if (cleanedQuery.equals("/")) {
                                        ...
                                        var roots = new Array();
                                        roots[0] = rootObj;
                                        org.kevoree.modeling.api.traversal.KSelector.select(rootObj.view(), roots, cleanedQuery, callback);
                                    }
                                }
                            });
                        };
                ...
                (function (traversal) {
                    ...
                    var KQuery = (function () {
                        ...
                        KQuery.extractFirstQuery = function (query) {
                            ...
                            if (query.charAt(0) == KQuery.QUERY_SEP) {
                                ...
                                return new org.kevoree.modeling.api.traversal.KQuery("", params, subQuery, "" + KQuery.QUERY_SEP, false, false);
                            }
                            if (query.startsWith("**/")) {
                                if (query.length > 3) {
                                    var next = org.kevoree.modeling.api.traversal.KQuery.extractFirstQuery(query.substring(3));
                                    if (next != null) {
                            ...
                            if (query.startsWith("***/")) {
                                if (query.length > 4) {
                                    var next = org.kevoree.modeling.api.traversal.KQuery.extractFirstQuery(query.substring(4));
                                    if (next != null) {
                                        next.previousIsDeep = true;
                                ...
                                if (attsEnd != 0) {
                                        ...
                                        if (paramString.charAt(iParam) == ',' && !escaped) {
                                            ...
                                            if (p.equals("") && !p.equals("*")) {
                                                ...
                                                if (pArray.length > 1) {
                                                    ...
                                                    pObject = new org.kevoree.modeling.api.traversal.KQueryParam(paramKey.replace("!", ""), pArray[1].trim(), negative);
                                                    params.put(pObject.name(), pObject);
                                                }
                                                else {
                                                    pObject = new org.kevoree.modeling.api.traversal.KQueryParam(null, p, false);
                                    ...
                                    if (!lastParam.equals("") && !lastParam.equals("*")) {
                                        ...
                                        if (pArray.length > 1) {
                                            ...
                                            pObject = new org.kevoree.modeling.api.traversal.KQueryParam(null, lastParam, false);
                                            params.put("@id", pObject);
                                        }
                                    }
                                }
                                return new org.kevoree.modeling.api.traversal.KQuery(relName, params, subQuery, oldString, false, false);
                            }
                            return null;
                        };
                        KQuery.OPEN_BRACKET = '[';
                    ...
                    traversal.KQueryParam = KQueryParam;
                    var KSelector = (function () {
                        ...
                        KSelector.select = function (view, roots, query, callback) {
                            ...
                            var extractedQuery = org.kevoree.modeling.api.traversal.KQuery.extractFirstQuery(query);
                            if (extractedQuery == null) {
                                ...
                                for (var k = 0; k < roots.length; k++) {
                                    var root = roots[k];
                                    var raw = root.universe().model().storage().raw(root, org.kevoree.modeling.api.data.AccessMode.READ);
                                    if (raw != null) {
                                ...
                                view.lookupAll(collected.toArray(new Array()), function (resolveds) {
                                    ...
                                    if (extractedQuery.subQuery == null || extractedQuery.subQuery.isEmpty()) {
                                        ...
                                        org.kevoree.modeling.api.traversal.KSelector.select(view, nextArr, extractedQuery.subQuery, callback);
                                    }
                                });
                            }
                        };
        ...
        (function (diamond) {
            ...
            (function (impl) {
                var AImpl = (function (_super) {
                    ...
                    AImpl.prototype.getRef_a2 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaA.REF_REF_A2, function (kObjects) {
                            if (p_callback != null) {
                    ...
                    AImpl.prototype.getRef_a1 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaA.REF_REF_A1, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                ...
                var BImpl = (function (_super) {
                    ...
                    BImpl.prototype.getRef_a2 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaB.REF_REF_A2, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    BImpl.prototype.getRef_b2 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaB.REF_REF_B2, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    BImpl.prototype.getRef_a1 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaB.REF_REF_A1, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    BImpl.prototype.getRef_b1 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaB.REF_REF_B1, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                ...
                var CLImpl = (function (_super) {
                    ...
                    CLImpl.prototype.getRef_cl1 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaCL.REF_REF_CL1, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    CLImpl.prototype.getRef_a2 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaCL.REF_REF_A2, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    CLImpl.prototype.getRef_b2 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaCL.REF_REF_B2, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    CLImpl.prototype.getRef_a1 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaCL.REF_REF_A1, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    CLImpl.prototype.getRef_b1 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaCL.REF_REF_B1, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                ...
                var CRAImpl = (function (_super) {
                    ...
                    CRAImpl.prototype.getRef_cra1 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaCRA.REF_REF_CRA1, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    CRAImpl.prototype.getRef_a2 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaCRA.REF_REF_A2, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    CRAImpl.prototype.getRef_b2 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaCRA.REF_REF_B2, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    CRAImpl.prototype.getRef_a1 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaCRA.REF_REF_A1, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    CRAImpl.prototype.getRef_b1 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaCRA.REF_REF_B1, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                ...
                var CRImpl = (function (_super) {
                    ...
                    CRImpl.prototype.getRef_a2 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaCR.REF_REF_A2, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    CRImpl.prototype.getRef_b2 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaCR.REF_REF_B2, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    CRImpl.prototype.getRef_a1 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaCR.REF_REF_A1, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    CRImpl.prototype.getRef_b1 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaCR.REF_REF_B1, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                ...
                var DImpl = (function (_super) {
                    ...
                    DImpl.prototype.getRef_cl1 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaD.REF_REF_CL1, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    DImpl.prototype.getRef_cra1 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaD.REF_REF_CRA1, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    DImpl.prototype.getRef_a2 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaD.REF_REF_A2, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    DImpl.prototype.getRef_b2 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaD.REF_REF_B2, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    DImpl.prototype.getRef_a1 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaD.REF_REF_A1, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    DImpl.prototype.getRef_b1 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaD.REF_REF_B1, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    DImpl.prototype.getRef_d1 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaD.REF_REF_D1, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                ...
                var EImpl = (function (_super) {
                    ...
                    EImpl.prototype.getRef_cl1 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaE.REF_REF_CL1, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    EImpl.prototype.getRef_cra1 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaE.REF_REF_CRA1, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    EImpl.prototype.getRef_a2 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaE.REF_REF_A2, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    EImpl.prototype.getRef_b2 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaE.REF_REF_B2, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    EImpl.prototype.getRef_a1 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaE.REF_REF_A1, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    EImpl.prototype.getRef_b1 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaE.REF_REF_B1, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    EImpl.prototype.getRef_d1 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaE.REF_REF_D1, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
                    ...
                    EImpl.prototype.getRef_e1 = function (p_callback) {
                        this.all(org.kevoree.diamond.meta.MetaE.REF_REF_E1, function (kObjects) {
                            if (p_callback != null) {
                                if (kObjects.length > 0) {
                                    p_callback(kObjects[0]);
                                }
            ...
            (function (meta) {
                var MetaA = (function (_super) {
                    ...
                    MetaA.INSTANCE = null;
                    MetaA.ATT_ATT_A1 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_a1", 5, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaA.ATT_ATT_A2 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_a2", 6, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                ...
                var MetaB = (function (_super) {
                    ...
                    MetaB.INSTANCE = null;
                    MetaB.ATT_ATT_B2 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_b2", 5, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaB.ATT_ATT_A1 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_a1", 6, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaB.ATT_ATT_A2 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_a2", 7, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaB.ATT_ATT_B1 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_b1", 8, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                ...
                var MetaCL = (function (_super) {
                    ...
                    MetaCL.ATT_ATT_B2 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_b2", 5, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaCL.ATT_ATT_A1 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_a1", 6, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaCL.ATT_ATT_A2 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_a2", 7, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaCL.ATT_ATT_B1 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_b1", 8, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                ...
                var MetaCR = (function (_super) {
                    ...
                    MetaCR.ATT_ATT_B2 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_b2", 5, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaCR.ATT_ATT_A1 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_a1", 6, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaCR.ATT_ATT_A2 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_a2", 7, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaCR.ATT_ATT_B1 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_b1", 8, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaCR.ATT_ATT_CR2 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_cr2", 9, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaCR.ATT_ATT_CR1 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_cr1", 10, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaCR.ATT_ATT_CR3 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_cr3", 11, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                ...
                var MetaCRA = (function (_super) {
                    ...
                    MetaCRA.ATT_ATT_B2 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_b2", 5, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaCRA.ATT_ATT_A1 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_a1", 6, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaCRA.ATT_ATT_A2 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_a2", 7, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaCRA.ATT_ATT_B1 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_b1", 8, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaCRA.ATT_ATT_CR2 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_cr2", 9, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaCRA.ATT_ATT_CR1 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_cr1", 10, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaCRA.ATT_ATT_CR3 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_cr3", 11, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                ...
                var MetaD = (function (_super) {
                    ...
                    MetaD.INSTANCE = null;
                    MetaD.ATT_ATT_B2 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_b2", 5, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaD.ATT_ATT_A1 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_a1", 6, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaD.ATT_ATT_A2 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_a2", 7, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaD.ATT_ATT_D2 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_d2", 8, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaD.ATT_ATT_B1 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_b1", 9, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaD.ATT_ATT_D1 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_d1", 10, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaD.ATT_ATT_CR2 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_cr2", 11, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaD.ATT_ATT_CR1 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_cr1", 12, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaD.ATT_ATT_CR3 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_cr3", 13, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                ...
                var MetaE = (function (_super) {
                    ...
                    MetaE.INSTANCE = null;
                    MetaE.ATT_ATT_B2 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_b2", 5, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaE.ATT_ATT_A1 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_a1", 6, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaE.ATT_ATT_A2 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_a2", 7, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaE.ATT_ATT_D2 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_d2", 8, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaE.ATT_ATT_B1 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_b1", 9, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaE.ATT_ATT_E1 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_e1", 10, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaE.ATT_ATT_E2 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_e2", 11, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaE.ATT_ATT_D1 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_d1", 12, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaE.ATT_ATT_CR2 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_cr2", 13, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaE.ATT_ATT_CR1 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_cr1", 14, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    MetaE.ATT_ATT_CR3 = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("att_cr3", 15, 0, false, org.kevoree.modeling.api.meta.PrimitiveMetaTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
