				...
				export module test {
					...
					export class CallbackTester {
					  ...
					  public callbackTest(): void {
					    ...
					    org.kevoree.modeling.api.util.Helper.forall(big, {on:function(s: string, next: org.kevoree.modeling.api.Callback<java.lang.Throwable>){
					    System.out.println(s);
					    next.on(null);
					}}, {on:function(t: java.lang.Throwable){
					...
					export module cloud {
						...
						export class CloudDimension extends org.kevoree.modeling.api.abs.AbstractKDimension<CloudView, CloudDimension, CloudUniverse> {
						...
						export class CloudUniverse extends org.kevoree.modeling.api.abs.AbstractKUniverse<CloudDimension> {
						...
						export interface Element extends org.kevoree.modeling.api.KObject<Element, CloudView> {
						...
						export module impl {
							...
							export class CloudViewImpl extends org.kevoree.modeling.api.abs.AbstractKView implements org.kevoree.modeling.microframework.test.cloud.CloudView {
							  ...
							  public createNode(): org.kevoree.modeling.microframework.test.cloud.Node {
							    return <org.kevoree.modeling.microframework.test.cloud.Node>create(METACLASSES.ORG_KEVOREE_MODELING_MICROFRAMEWORK_TEST_CLOUD_NODE);
							  }
							
							  public createElement(): org.kevoree.modeling.microframework.test.cloud.Element {
							    return <org.kevoree.modeling.microframework.test.cloud.Element>create(METACLASSES.ORG_KEVOREE_MODELING_MICROFRAMEWORK_TEST_CLOUD_ELEMENT);
							  }
							
							}
							
							export class ElementImpl extends org.kevoree.modeling.api.abs.AbstractKObject<org.kevoree.modeling.microframework.test.cloud.Element, org.kevoree.modeling.microframework.test.cloud.CloudView> implements org.kevoree.modeling.microframework.test.cloud.Element {
							...
							export class NodeImpl extends org.kevoree.modeling.api.abs.AbstractKObject<org.kevoree.modeling.microframework.test.cloud.Node, org.kevoree.modeling.microframework.test.cloud.CloudView> implements org.kevoree.modeling.microframework.test.cloud.Node {
							  ...
							  public setName(name: string): org.kevoree.modeling.microframework.test.cloud.Node {
							    set(METAATTRIBUTES.NAME, name);
							    return this;
							  }
							  ...
							  public setValue(name: string): org.kevoree.modeling.microframework.test.cloud.Node {
							    set(METAATTRIBUTES.VALUE, name);
							    return this;
							  }
							
							  public addChildren(obj: org.kevoree.modeling.microframework.test.cloud.Node): void {
							    mutate(org.kevoree.modeling.api.KActionType.ADD, METAREFERENCES.CHILDREN, obj, true);
							  }
							
							  public removeChildren(obj: org.kevoree.modeling.microframework.test.cloud.Node): void {
							    mutate(org.kevoree.modeling.api.KActionType.REMOVE, METAREFERENCES.CHILDREN, obj, true);
							  }
							
							  public eachChildren(callback: org.kevoree.modeling.api.Callback<org.kevoree.modeling.microframework.test.cloud.Node>, end: org.kevoree.modeling.api.Callback<java.lang.Throwable>): void {
							    each(METAREFERENCES.CHILDREN, callback, end);
							  }
							
							  public setElement(obj: org.kevoree.modeling.microframework.test.cloud.Element): void {
							    mutate(org.kevoree.modeling.api.KActionType.SET, METAREFERENCES.ELEMENT, obj, true);
							  }
							
							  public getElement(callback: org.kevoree.modeling.api.Callback<org.kevoree.modeling.microframework.test.cloud.Element>): void {
						...
						export interface Node extends org.kevoree.modeling.api.KObject<Node, CloudView> {
						  ...
						  trigger(param: string, callback: org.kevoree.modeling.api.Callback<string>): void;
					...
					export class CompareTest {
					  ...
					  public diffTest(): void {
					    ...
					    t0.createModelCompare().diff(node0_0, node0_1, {on:function(traceSequence: org.kevoree.modeling.api.trace.TraceSequence){
					    ...
					    t0.createModelCompare().diff(node0_0, node0_1, {on:function(traceSequence: org.kevoree.modeling.api.trace.TraceSequence){
					    new org.kevoree.modeling.api.trace.ModelTraceApplicator(node0_0).applyTraceSequence(traceSequence, {on:function(throwable: java.lang.Throwable){
					  ...
					  public intersectionTest(): void {
					    ...
					    node0_1.setName("node0_1");
					    node0_1.setValue("0_1");
					    t0.createModelCompare().intersection(node0_0, node0_1, {on:function(traceSequence: org.kevoree.modeling.api.trace.TraceSequence){
					    org.junit.Assert.assertEquals(traceSequence.traces().length, 0);
					}});
					    var node0_2: org.kevoree.modeling.microframework.test.cloud.Node = t0.createNode();
					    node0_2.setName("node0_2");
					    node0_2.setValue("0_1");
					    t0.createModelCompare().intersection(node0_2, node0_1, {on:function(traceSequence: org.kevoree.modeling.api.trace.TraceSequence){
					  ...
					  public unionTest(): void {
					    ...
					    node0_1.setName("node0_1");
					    node0_1.setValue("0_1");
					    t0.createModelCompare().union(node0_0, node0_1, {on:function(traceSequence: org.kevoree.modeling.api.trace.TraceSequence){
					    ...
					    new org.kevoree.modeling.api.trace.ModelTraceApplicator(node0_0).applyTraceSequence(traceSequence, {on:function(throwable: java.lang.Throwable){
					    node0_0.getElement({on:function(element: org.kevoree.modeling.microframework.test.cloud.Element){
					...
					export class HelloTest {
					  ...
					  public helloTest(): void {
					    ...
					    univers.listen({on:function(evt: org.kevoree.modeling.api.KEvent){
					    System.err.println(evt);
					}});
					    univers.newDimension({on:function(dimension0: org.kevoree.modeling.microframework.test.cloud.CloudDimension){
					    org.junit.Assert.assertNotNull(dimension0);
					    var t0: org.kevoree.modeling.microframework.test.cloud.CloudView = dimension0.time(0);
					    ...
					    var i: number[] = [0];
					    nodeT0.eachChildren({on:function(n: org.kevoree.modeling.microframework.test.cloud.Node){
					    i[0]++;
					}}, null);
					    ...
					    i[0] = 0;
					    var j: number[] = [0];
					    nodeT0.visit({visit:function(elem: org.kevoree.modeling.api.KObject<any,any>){
					    i[0]++;
					    return org.kevoree.modeling.api.VisitResult.CONTINUE;
					}}, {on:function(t: java.lang.Throwable){
					    j[0]++;
					    ...
					    i[0] = 0;
					    j[0] = 0;
					    nodeT1.visit({visit:function(elem: org.kevoree.modeling.api.KObject<any,any>){
					    i[0]++;
					    return org.kevoree.modeling.api.VisitResult.CONTINUE;
					}}, {on:function(t: java.lang.Throwable){
					    j[0]++;
					    ...
					    i[0] = 0;
					    j[0] = 0;
					    nodeT3.visit({visit:function(elem: org.kevoree.modeling.api.KObject<any,any>){
					    i[0]++;
					    return org.kevoree.modeling.api.VisitResult.CONTINUE;
					}}, {on:function(t: java.lang.Throwable){
					    j[0]++;
					    ...
					    i[0] = 0;
					    j[0] = 0;
					    nodeT0.treeVisit({visit:function(elem: org.kevoree.modeling.api.KObject<any,any>){
					    i[0]++;
					    return org.kevoree.modeling.api.VisitResult.CONTINUE;
					}}, {on:function(t: java.lang.Throwable){
					    j[0]++;
					    ...
					    i[0] = 0;
					    j[0] = 0;
					    nodeT0.graphVisit({visit:function(elem: org.kevoree.modeling.api.KObject<any,any>){
					    i[0]++;
					    return org.kevoree.modeling.api.VisitResult.CONTINUE;
					}}, {on:function(t: java.lang.Throwable){
					    j[0]++;
					...
					export module json {
						...
						export class JSONLoadTest {
						  ...
						  public jsonTest(): void {
						    ...
						    var loader: org.kevoree.modeling.api.ModelLoader = time0.createJSONLoader();
						    loader.load("[\n" + "{\n" + "\t\"@meta\" : \"org.kevoree.modeling.microframework.test.cloud.Node\",\n" + "\t\"@uuid\" : \"1\",\n" + "\t\"name\":\"root\",\n" + "\t\"children\": [\"2\",\"3\"],\n" + "}\n" + ",{\n" + "\t\"@meta\" : \"org.kevoree.modeling.microframework.test.cloud.Node\",\n" + "\t\"@uuid\" : \"2\",\n" + "\t\"name\":\"n1\",\n" + "}\n" + ",{\n" + "\t\"@meta\" : \"org.kevoree.modeling.microframework.test.cloud.Node\",\n" + "\t\"@uuid\" : \"3\",\n" + "\t\"name\":\"n2\",\n" + "}\n" + "]", {on:function(res: java.lang.Throwable){
						    time0.lookup(1, {on:function(r: org.kevoree.modeling.api.KObject<any,any>){
						...
						export class JSONSaveTest {
						  ...
						  public jsonTest(): void {
						    ...
						    time0.createJSONSerializer().serialize(root, {on:function(model: string, err: java.lang.Throwable){
						    result[0] = model;
						    if (err != null) {
						      err.printStackTrace();
						    }
					...
					export class LookupTest {
					  ...
					  public lookupTest(): void {
					    ...
					    universe.storage().getRoot(t0, {on:function(resolvedRoot: org.kevoree.modeling.api.KObject<any,any>){
					    org.junit.Assert.assertEquals(node, resolvedRoot);
					}});
					    org.junit.Assert.assertTrue(node.isRoot());
					    dimension0.save({on:function(e: java.lang.Throwable){
					    ...
					    universe2.dimension(dimension0.key(), {on:function(dimension0_2: org.kevoree.modeling.microframework.test.cloud.CloudDimension){
					    var t0_2: org.kevoree.modeling.microframework.test.cloud.CloudView = dimension0_2.time(0);
					    t0_2.lookup(node.uuid(), {on:function(resolved: org.kevoree.modeling.api.KObject<any,any>){
					    t0_2.lookup(node.uuid(), {on:function(resolved2: org.kevoree.modeling.api.KObject<any,any>){
					    org.junit.Assert.assertEquals(resolved, resolved2);
					}});
					    universe2.storage().getRoot(t0_2, {on:function(resolvedRoot: org.kevoree.modeling.api.KObject<any,any>){
					...
					export class SliceTest {
					  ...
					  public slideTest(): void {
					    ...
					    root.addChildren(n1);
					    root.addChildren(n2);
					    var slicer: org.kevoree.modeling.api.ModelSlicer = time0.createModelSlicer();
					}});
					  }
					...
					export class TimeTest {
					  ...
					  public simpleTimeNavigationTest(): void {
					    ...
					    node0.getElement({on:function(element: org.kevoree.modeling.microframework.test.cloud.Element){
					    org.junit.Assert.assertEquals(element, element0);
					    org.junit.Assert.assertEquals(element.now(), t0.now());
					}});
					    t0.lookup(node0.uuid(), {on:function(kObject: org.kevoree.modeling.api.KObject<any,any>){
					    (<org.kevoree.modeling.microframework.test.cloud.Node>kObject).getElement({on:function(element: org.kevoree.modeling.microframework.test.cloud.Element){
					    org.junit.Assert.assertEquals(element, element0);
					    org.junit.Assert.assertEquals(element.now(), t0.now());
					}});
					}});
					  ...
					  public distortedTimeNavigationTest(): void {
					    ...
					    t1.lookup(node0.uuid(), {on:function(kObject: org.kevoree.modeling.api.KObject<any,any>){
					    (<org.kevoree.modeling.microframework.test.cloud.Node>kObject).getElement({on:function(element: org.kevoree.modeling.microframework.test.cloud.Element){
					...
					export class TraceTest {
					  ...
					  public traceTest(): void {
					    ...
					    root.addChildren(n1);
					    root.addChildren(n2);
					    var compare: org.kevoree.modeling.api.ModelCompare = time0.createModelCompare();
					}});
					  }
					...
					export module xmi {
						...
						export class Serializer {
						  ...
						  public serializeTest(): void {
						    ...
						    nodeT1.setName("n1");
						    nodeT0.addChildren(nodeT1);
						    t0.lookup(nodeT0.uuid(), {on:function(root: org.kevoree.modeling.api.KObject<any,any>){
						    t0.createXMISerializer().serialize(root, {on:function(result: string, error: java.lang.Throwable){
						    if (error != null) {
						      error.printStackTrace();
						    }
						}});
