    ...
    export module kevoree {
        export module modeling {
            export module microframework {
                export module test {
                    export class AllTestRunner {

                        public static main(args: string[]): void {
                            var compareTest: org.kevoree.modeling.microframework.test.CompareTest = new org.kevoree.modeling.microframework.test.CompareTest();
                            compareTest.diffTest();
                            compareTest.intersectionTest();
                            compareTest.unionTest();
                        }
