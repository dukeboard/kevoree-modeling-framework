                ...
                (function (test) {
                    var CallbackTester = (function () {
                        ...
                        CallbackTester.prototype.callbackTest = function () {
                            ...
                            org.kevoree.modeling.api.util.Helper.forall(big, { on: function (s, next) {
                    ...
                    (function (cloud) {
                        ...
                        (function (Element) {
                            var METAATTRIBUTES = (function () {
                                ...
                                METAATTRIBUTES.NAME = new METAATTRIBUTES("name", 2, 5, true, org.kevoree.modeling.api.meta.MetaType.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                                METAATTRIBUTES.VALUE = new METAATTRIBUTES("value", 3, 5, false, org.kevoree.modeling.api.meta.MetaType.LONG, org.kevoree.modeling.api.extrapolation.PolynomialExtrapolation.instance());
                        ...
                        (function (Node) {
                            var METAATTRIBUTES = (function () {
                                ...
                                METAATTRIBUTES.NAME = new METAATTRIBUTES("name", 2, 5, true, org.kevoree.modeling.api.meta.MetaType.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                                METAATTRIBUTES.VALUE = new METAATTRIBUTES("value", 3, 5, false, org.kevoree.modeling.api.meta.MetaType.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                                METAATTRIBUTES._METAATTRIBUTESVALUES = [
                                    METAATTRIBUTES.NAME,
                                    METAATTRIBUTES.VALUE
                                ];
                    ...
                    var CompareTest = (function () {
                        ...
                        CompareTest.prototype.diffTest = function () {
                            ...
                            universe.newDimension({ on: function (dimension0) {
                                ...
                                t0.diff(node0_0, node0_1, { on: function (traceSequence) {
                                ...
                                t0.diff(node0_0, node0_1, { on: function (traceSequence) {
                                    new org.kevoree.modeling.api.trace.ModelTraceApplicator(node0_0).applyTraceSequence(traceSequence, { on: function (throwable) {
                        ...
                        CompareTest.prototype.intersectionTest = function () {
                            ...
                            universe.newDimension({ on: function (dimension0) {
                                ...
                                node0_1.setName("node0_1");
                                node0_1.setValue("0_1");
                                t0.intersection(node0_0, node0_1, { on: function (traceSequence) {
                                    org.junit.Assert.assertEquals(traceSequence.traces().length, 0);
                                } });
                                var node0_2 = t0.createNode();
                                node0_2.setName("node0_2");
                                node0_2.setValue("0_1");
                                t0.intersection(node0_2, node0_1, { on: function (traceSequence) {
                        ...
                        CompareTest.prototype.unionTest = function () {
                            ...
                            universe.newDimension({ on: function (dimension0) {
                                ...
                                node0_1.setName("node0_1");
                                node0_1.setValue("0_1");
                                t0.merge(node0_0, node0_1, { on: function (traceSequence) {
                                    ...
                                    new org.kevoree.modeling.api.trace.ModelTraceApplicator(node0_0).applyTraceSequence(traceSequence, { on: function (throwable) {
                                        node0_0.getElement({ on: function (element) {
                    ...
                    var HelloTest = (function () {
                        ...
                        HelloTest.prototype.helloTest = function () {
                            ...
                            univers.listen({ on: function (evt) {
                                System.err.println(evt);
                            } });
                            univers.newDimension({ on: function (dimension0) {
                                org.junit.Assert.assertNotNull(dimension0);
                                var t0 = dimension0.time(0);
                                ...
                                var i = [0];
                                nodeT0.eachChildren({ on: function (n) {
                                    i[0]++;
                                } }, null);
                                ...
                                i[0] = 0;
                                var j = [0];
                                nodeT0.visit({ visit: function (elem) {
                                    i[0]++;
                                    return org.kevoree.modeling.api.VisitResult.CONTINUE;
                                } }, { on: function (t) {
                                    j[0]++;
                                ...
                                i[0] = 0;
                                j[0] = 0;
                                nodeT1.visit({ visit: function (elem) {
                                    i[0]++;
                                    return org.kevoree.modeling.api.VisitResult.CONTINUE;
                                } }, { on: function (t) {
                                    j[0]++;
                                ...
                                i[0] = 0;
                                j[0] = 0;
                                nodeT3.visit({ visit: function (elem) {
                                    i[0]++;
                                    return org.kevoree.modeling.api.VisitResult.CONTINUE;
                                } }, { on: function (t) {
                                    j[0]++;
                                ...
                                i[0] = 0;
                                j[0] = 0;
                                nodeT0.treeVisit({ visit: function (elem) {
                                    i[0]++;
                                    return org.kevoree.modeling.api.VisitResult.CONTINUE;
                                } }, { on: function (t) {
                                    j[0]++;
                                ...
                                i[0] = 0;
                                j[0] = 0;
                                nodeT0.graphVisit({ visit: function (elem) {
                                    i[0]++;
                                    return org.kevoree.modeling.api.VisitResult.CONTINUE;
                                } }, { on: function (t) {
                                    j[0]++;
                        ...
                        var JSONSaveTest = (function () {
                            ...
                            JSONSaveTest.prototype.jsonTest = function () {
                                ...
                                universe.newDimension({ on: function (dimension0) {
                                    ...
                                    root.addChildren(n2);
                                    var result = new Array();
                                    time0.json().save(root, { on: function (model, err) {
                                        result[0] = model;
                                        if (err != null) {
                                            err.printStackTrace();
                                        }
                    ...
                    var LookupTest = (function () {
                        ...
                        LookupTest.prototype.lookupTest = function () {
                            ...
                            universe.newDimension({ on: function (dimension0) {
                                ...
                                universe.storage().getRoot(t0, { on: function (resolvedRoot) {
                                    org.junit.Assert.assertEquals(node, resolvedRoot);
                                } });
                                org.junit.Assert.assertTrue(node.isRoot());
                                dimension0.save({ on: function (e) {
                                    var universe2 = new org.kevoree.modeling.microframework.test.cloud.CloudUniverse(dataBase);
                                    universe2.dimension(dimension0.key(), { on: function (dimension0_2) {
                                        var t0_2 = dimension0_2.time(0);
                                        t0_2.lookup(node.uuid(), { on: function (resolved) {
                                            t0_2.lookup(node.uuid(), { on: function (resolved2) {
                                                org.junit.Assert.assertEquals(resolved, resolved2);
                                            } });
                                            universe2.storage().getRoot(t0_2, { on: function (resolvedRoot) {
                    ...
                    (function (polynomial) {
                        var PolynomialKMFTest = (function () {
                            ...
                            PolynomialKMFTest.prototype.test = function () {
                                ...
                                universe.newDimension({ on: function (dimension0) {
                                    ...
                                    for (var i = 1; i <= 10000; i++) {
                                        var finalI = i;
                                        dimension0.time(finalI).lookup(element.uuid(), { on: function (kObject) {
                                            var casted = kObject;
                            ...
                            PolynomialKMFTest.prototype.test2 = function () {
                                var dataBase = new org.kevoree.modeling.api.data.MemoryKDataBase();
                                var universe = new org.kevoree.modeling.microframework.test.cloud.CloudUniverse(dataBase);
                                universe.newDimension({ on: function (dimension0) {
                                    var t0 = dimension0.time(0);
                        ...
                        var BasicSelectTest = (function () {
                            ...
                            BasicSelectTest.prototype.selectTest = function () {
                                ...
                                universe.newDimension({ on: function (dimension0) {
                                    ...
                                    t0.select("children[]", { on: function (selecteds) {
                                        org.junit.Assert.assertEquals(1, selecteds.length);
                                        org.junit.Assert.assertEquals(node2, selecteds[0]);
                                    } });
                                    t0.select("children[name=*]", { on: function (selecteds) {
                                        org.junit.Assert.assertEquals(1, selecteds.length);
                                        org.junit.Assert.assertEquals(node2, selecteds[0]);
                                    } });
                                    t0.select("children[name=n*]", { on: function (selecteds) {
                                        org.junit.Assert.assertEquals(1, selecteds.length);
                                        org.junit.Assert.assertEquals(node2, selecteds[0]);
                                    } });
                                    t0.select("children[name=n1]", { on: function (selecteds) {
                                        org.junit.Assert.assertEquals(1, selecteds.length);
                                        org.junit.Assert.assertEquals(node2, selecteds[0]);
                                    } });
                                    t0.select("children[name=!n1]", { on: function (selecteds) {
                                    ...
                                    t0.select("children[name=n1]/children[name=n2]", { on: function (selecteds) {
                                        org.junit.Assert.assertEquals(1, selecteds.length);
                                    ...
                                    node.select("children[name=n1]/children[name=n2]", { on: function (selecteds) {
                                        org.junit.Assert.assertEquals(1, selecteds.length);
                                        org.junit.Assert.assertEquals(node3, selecteds[0]);
                                    } });
                                    node.select("/children[name=n1]/children[name=n2]", { on: function (selecteds) {
                                    ...
                                    node.select("children[name=n1]/children[name=n2]/children[name=*]", { on: function (selecteds) {
                    ...
                    var TimeTest = (function () {
                        ...
                        TimeTest.prototype.simpleTimeNavigationTest = function () {
                            ...
                            universe.newDimension({ on: function (dimension0) {
                                ...
                                node0.getElement({ on: function (element) {
                                    org.junit.Assert.assertEquals(element, element0);
                                    org.junit.Assert.assertEquals(element.now(), t0.now());
                                } });
                                t0.lookup(node0.uuid(), { on: function (kObject) {
                                    kObject.getElement({ on: function (element) {
                                        org.junit.Assert.assertEquals(element, element0);
                                        org.junit.Assert.assertEquals(element.now(), t0.now());
                                    } });
                                } });
                        ...
                        TimeTest.prototype.distortedTimeNavigationTest = function () {
                            ...
                            universe.newDimension({ on: function (dimension0) {
                                ...
                                t1.lookup(node0.uuid(), { on: function (kObject) {
                                    kObject.getElement({ on: function (element) {
                        ...
                        var Serializer = (function () {
                            ...
                            Serializer.prototype.serializeTest = function () {
                                ...
                                universe.newDimension({ on: function (dimension0) {
                                    ...
                                    nodeT1.setName("n1");
                                    nodeT0.addChildren(nodeT1);
                                    t0.lookup(nodeT0.uuid(), { on: function (root) {
                                        t0.xmi().save(root, { on: function (result, error) {
                                            if (error != null) {
                                                error.printStackTrace();
                                            }
                                        } });
