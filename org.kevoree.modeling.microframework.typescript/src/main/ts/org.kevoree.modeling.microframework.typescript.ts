        ...
        export module modeling {
            ...
            export module abs {
                ...
                export class AbstractKObject implements org.kevoree.modeling.KObject {
                    ...
                    private internal_visit(visitor: (p : org.kevoree.modeling.KObject) => org.kevoree.modeling.traversal.visitor.KVisitResult, end: (p : any) => void, visited: org.kevoree.modeling.memory.struct.map.impl.ArrayLongLongHashMap, traversed: org.kevoree.modeling.memory.struct.map.impl.ArrayLongLongHashMap): void {
                        if (!org.kevoree.modeling.util.Checker.isDefined(visitor)) {
                            return;
                        }
                        if (traversed != null) {
                    ...
                    public jump(p_time: number, p_callback: (p : org.kevoree.modeling.KObject) => void): void {
                        ...
                        if (resolve_entry != null) {
                            ...
                            timeTree.inc();
                            var universeTree: org.kevoree.modeling.memory.struct.map.impl.ArrayLongLongHashMap = <org.kevoree.modeling.memory.struct.map.impl.ArrayLongLongHashMap>this._manager.cache().get(org.kevoree.modeling.KConfig.NULL_LONG, org.kevoree.modeling.KConfig.NULL_LONG, this._uuid);
                            universeTree.inc();
                            resolve_entry.inc();
                ...
                export class AbstractTimeWalker implements org.kevoree.modeling.KTimeWalker {
                    ...
                    private internal_times(start: number, end: number, cb: (p : number[]) => void): void {
                        ...
                        manager.bumpKeysToCache(keys,  (kMemoryElements : org.kevoree.modeling.memory.KMemoryElement[]) => {
                            var objUniverse: org.kevoree.modeling.memory.struct.map.impl.ArrayLongLongHashMap = <org.kevoree.modeling.memory.struct.map.impl.ArrayLongLongHashMap>kMemoryElements[1];
                            if (kMemoryElements[0] == null || kMemoryElements[1] == null) {
                                cb(null);
                            } else {
                                var collectedUniverse: number[] = org.kevoree.modeling.memory.manager.impl.ResolutionHelper.universeSelectByRange(<org.kevoree.modeling.memory.struct.map.impl.ArrayLongLongHashMap>kMemoryElements[0], <org.kevoree.modeling.memory.struct.map.impl.ArrayLongLongHashMap>kMemoryElements[1], start, end, this._origin.universe());
            ...
            export module format {
                ...
                export module json {
                    ...
                    export class JsonModelLoader {
                        ...
                        private static loadObj(p_param: org.kevoree.modeling.memory.struct.map.impl.ArrayStringHashMap<any>, manager: org.kevoree.modeling.memory.manager.KMemoryManager, universe: number, time: number, p_mappedKeys: org.kevoree.modeling.memory.struct.map.impl.ArrayLongLongHashMap, p_rootElem: org.kevoree.modeling.KObject[]): void {
                        ...
                        private static transposeArr(plainRawSet: java.util.ArrayList<string>, p_mappedKeys: org.kevoree.modeling.memory.struct.map.impl.ArrayLongLongHashMap): number[] {
                ...
                export module manager {
                    ...
                    export module impl {
                        export class HeapMemoryManager implements org.kevoree.modeling.memory.manager.KMemoryManager {
                            ...
                            public globalUniverseOrder(): org.kevoree.modeling.memory.struct.map.impl.ArrayLongLongHashMap {
                                return <org.kevoree.modeling.memory.struct.map.impl.ArrayLongLongHashMap>this._cache.get(org.kevoree.modeling.KConfig.NULL_LONG, org.kevoree.modeling.KConfig.NULL_LONG, org.kevoree.modeling.KConfig.NULL_LONG);
                            }
                            ...
                            public getRoot(universe: number, time: number, callback: (p : org.kevoree.modeling.KObject) => void): void {
                                this.bumpKeyToCache(org.kevoree.modeling.KContentKey.createRootUniverseTree(),  (rootGlobalUniverseIndex : org.kevoree.modeling.memory.KMemoryElement) => {
                                    if (rootGlobalUniverseIndex == null) {
                                        ...
                                        var closestUniverse: number = org.kevoree.modeling.memory.manager.impl.ResolutionHelper.resolve_universe(this.globalUniverseOrder(), <org.kevoree.modeling.memory.struct.map.impl.ArrayLongLongHashMap>rootGlobalUniverseIndex, time, universe);
                            ...
                            public setRoot(newRoot: org.kevoree.modeling.KObject, callback: (p : java.lang.Throwable) => void): void {
                                this.bumpKeyToCache(org.kevoree.modeling.KContentKey.createRootUniverseTree(),  (globalRootTree : org.kevoree.modeling.memory.KMemoryElement) => {
                                    var cleanedTree: org.kevoree.modeling.memory.struct.map.impl.ArrayLongLongHashMap = <org.kevoree.modeling.memory.struct.map.impl.ArrayLongLongHashMap>globalRootTree;
                                    if (cleanedTree == null) {
                                ...
                                this._store.bumpKeysToCache(tempKeys,  (universeIndexes : org.kevoree.modeling.memory.KMemoryElement[]) => {
                                    for (var i: number = 0; i < this._keys.length; i++) {
                                        ...
                                        if (universeIndexes[i] != null) {
                                            var closestUniverse: number = org.kevoree.modeling.memory.manager.impl.ResolutionHelper.resolve_universe(this._store.globalUniverseOrder(), <org.kevoree.modeling.memory.struct.map.impl.ArrayLongLongHashMap>universeIndexes[i], this._time, this._universe);
                                            ...
                                            for (var i: number = 0; i < this._keys.length; i++) {
                                                if (cachedObjects[i] != null && cachedObjects[i] instanceof org.kevoree.modeling.memory.struct.segment.impl.HeapMemorySegment) {
                                                    ...
                                                    if (proxies[i] != null) {
                                                        var cachedIndexTree: org.kevoree.modeling.memory.struct.tree.KLongTree = <org.kevoree.modeling.memory.struct.tree.KLongTree>timeIndexes[i];
                                                        cachedIndexTree.inc();
                                                        var universeTree: org.kevoree.modeling.memory.struct.map.impl.ArrayLongLongHashMap = <org.kevoree.modeling.memory.struct.map.impl.ArrayLongLongHashMap>universeIndexes[i];
                                                        universeTree.inc();
                                                        cachedObjects[i].inc();
                                                    }
                                                }
            ...
            export module operation {
                ...
                export module impl {
                    export class HashOperationManager implements org.kevoree.modeling.operation.KOperationManager {
                        ...
                        private staticOperations: org.kevoree.modeling.memory.struct.map.impl.ArrayIntHashMap<any>;
                        private instanceOperations: org.kevoree.modeling.memory.struct.map.impl.ArrayLongHashMap<any>;
                        private remoteCallCallbacks: org.kevoree.modeling.memory.struct.map.impl.ArrayLongHashMap<any> = new org.kevoree.modeling.memory.struct.map.impl.ArrayLongHashMap<any>(org.kevoree.modeling.KConfig.CACHE_INIT_SIZE, org.kevoree.modeling.KConfig.CACHE_LOAD_FACTOR);
                        private _manager: org.kevoree.modeling.memory.manager.KMemoryManager;
                        ...
                        public registerOperation(operation: org.kevoree.modeling.meta.KMetaOperation, callback: (p : org.kevoree.modeling.KObject, p1 : any[], p2 : (p : any) => void) => void, target: org.kevoree.modeling.KObject): void {
                            if (target == null) {
                                var clazzOperations: org.kevoree.modeling.memory.struct.map.impl.ArrayIntHashMap<any> = this.staticOperations.get(operation.origin().index());
                                ...
                                var objectOperations: org.kevoree.modeling.memory.struct.map.impl.ArrayIntHashMap<any> = this.instanceOperations.get(target.uuid());
                        ...
                        private searchOperation(source: number, clazz: number, operation: number): (p : org.kevoree.modeling.KObject, p1 : any[], p2 : (p : any) => void) => void {
                            var objectOperations: org.kevoree.modeling.memory.struct.map.impl.ArrayIntHashMap<any> = this.instanceOperations.get(source);
                            if (objectOperations != null) {
                                return objectOperations.get(operation);
                            }
                            var clazzOperations: org.kevoree.modeling.memory.struct.map.impl.ArrayIntHashMap<any> = this.staticOperations.get(clazz);
                            if (clazzOperations != null) {
                    ...
                    export module actions {
                        export class DeepCollectAction implements org.kevoree.modeling.traversal.KTraversalAction {
                            ...
                            private executeStep(p_inputStep: org.kevoree.modeling.KObject[], private_callback: (p : org.kevoree.modeling.KObject[]) => void): void {
                                ...
                                var nextIds: org.kevoree.modeling.memory.struct.map.impl.ArrayLongLongHashMap = new org.kevoree.modeling.memory.struct.map.impl.ArrayLongLongHashMap(org.kevoree.modeling.KConfig.CACHE_INIT_SIZE, org.kevoree.modeling.KConfig.CACHE_LOAD_FACTOR);
