        ...
        export module modeling {
            ...
            export module extrapolation {
                ...
                export class PolynomialExtrapolation implements org.kevoree.modeling.extrapolation.Extrapolation {
                    ...
                    public insert(time: number, value: number, timeOrigin: number, raw: org.kevoree.modeling.memory.KCacheElementSegment, index: number, precision: number, metaClass: org.kevoree.modeling.meta.MetaClass): boolean {
                        ...
                        if (deg < newMaxDegree) {
                            ...
                            values[ss] = value;
                            var pf: org.kevoree.modeling.extrapolation.maths.PolynomialFitEjml = new org.kevoree.modeling.extrapolation.maths.PolynomialFitEjml(deg);
                            pf.fit(times, values);
                    ...
                    private initial_feed(time: number, value: number, raw: org.kevoree.modeling.memory.KCacheElementSegment, index: number, metaClass: org.kevoree.modeling.meta.MetaClass): void {
                    ...
                    public mutate(current: org.kevoree.modeling.KObject, attribute: org.kevoree.modeling.meta.MetaAttribute, payload: any): void {
                        ...
                        if (!this.insert(current.now(), this.castNumber(payload), raw.originTime(), raw, attribute.index(), attribute.precision(), current.metaClass())) {
                            var raw2: org.kevoree.modeling.memory.KCacheElementSegment = (<org.kevoree.modeling.abs.AbstractKObject>current)._manager.segment(current, org.kevoree.modeling.memory.AccessMode.WRITE);
                            ...
                            this.insert(prevTime, val, prevTime, raw2, attribute.index(), attribute.precision(), current.metaClass());
                            this.insert(current.now(), this.castNumber(payload), raw2.originTime(), raw2, attribute.index(), attribute.precision(), current.metaClass());
                        } else {
                        }
                    }
                ...
                export module maths {
                    export class AdjLinearSolverQr {
                        ...
                        private decomposer: org.kevoree.modeling.extrapolation.maths.QRDecompositionHouseholderColumn_D64;
                        public maxRows: number = -1;
                        public maxCols: number = -1;
                        public Q: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F;
                        public R: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F;
                        private Y: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F;
                        private Z: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F;
                        public setA(A: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F): boolean {
                        ...
                        public solve(B: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F, X: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F): void {
                            ...
                            for (var colB: number = 0; colB < BnumCols; colB++) {
                                ...
                                org.kevoree.modeling.extrapolation.maths.DenseMatrix64F.multTransA(this.Q, this.Y, this.Z);
                        ...
                        constructor() {
                            this.decomposer = new org.kevoree.modeling.extrapolation.maths.QRDecompositionHouseholderColumn_D64();
                        }
                        ...
                        public setMaxSize(maxRows: number, maxCols: number): void {
                            ...
                            this.Q = new org.kevoree.modeling.extrapolation.maths.DenseMatrix64F(maxRows, maxRows);
                            this.R = new org.kevoree.modeling.extrapolation.maths.DenseMatrix64F(maxRows, maxCols);
                            this.Y = new org.kevoree.modeling.extrapolation.maths.DenseMatrix64F(maxRows, 1);
                            this.Z = new org.kevoree.modeling.extrapolation.maths.DenseMatrix64F(maxRows, 1);
                        }
                    ...
                    export class DenseMatrix64F {
                        ...
                        public static multTransA_smallMV(A: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F, B: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F, C: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F): void {
                            var cIndex: number = 0;
                        ...
                        public static multTransA_reorderMV(A: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F, B: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F, C: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F): void {
                            if (A.numRows == 0) {
                                org.kevoree.modeling.extrapolation.maths.DenseMatrix64F.fill(C, 0);
                                return;
                            }
                        ...
                        public static multTransA_reorderMM(a: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F, b: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F, c: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F): void {
                        ...
                        public static multTransA_smallMM(a: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F, b: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F, c: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F): void {
                            var cIndex: number = 0;
                            for (var i: number = 0; i < a.numCols; i++) {
                        ...
                        public static multTransA(a: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F, b: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F, c: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F): void {
                            if (b.numCols == 1) {
                                if (a.numCols >= org.kevoree.modeling.extrapolation.maths.DenseMatrix64F.MULT_COLUMN_SWITCH) {
                                    org.kevoree.modeling.extrapolation.maths.DenseMatrix64F.multTransA_reorderMV(a, b, c);
                                } else {
                                    org.kevoree.modeling.extrapolation.maths.DenseMatrix64F.multTransA_smallMV(a, b, c);
                                }
                            } else {
                                if (a.numCols >= org.kevoree.modeling.extrapolation.maths.DenseMatrix64F.MULT_COLUMN_SWITCH || b.numCols >= org.kevoree.modeling.extrapolation.maths.DenseMatrix64F.MULT_COLUMN_SWITCH) {
                                    org.kevoree.modeling.extrapolation.maths.DenseMatrix64F.multTransA_reorderMM(a, b, c);
                                } else {
                                    org.kevoree.modeling.extrapolation.maths.DenseMatrix64F.multTransA_smallMM(a, b, c);
                                }
                            }
                        }

                        public static setIdentity(mat: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F): void {
                        ...
                        public static widentity(width: number): org.kevoree.modeling.extrapolation.maths.DenseMatrix64F {
                            var ret: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F = new org.kevoree.modeling.extrapolation.maths.DenseMatrix64F(width, width);
                            for (var i: number = 0; i < width; i++) {
                                ret.cset(i, i, 1.0);
                            }
                            return ret;
                        ...
                        public static identity(numRows: number, numCols: number): org.kevoree.modeling.extrapolation.maths.DenseMatrix64F {
                            var ret: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F = new org.kevoree.modeling.extrapolation.maths.DenseMatrix64F(numRows, numCols);
                        ...
                        public static fill(a: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F, value: number): void {
                    ...
                    export class PolynomialFitEjml {
                        ...
                        public A: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F;
                        public coef: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F;
                        public y: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F;
                        public solver: org.kevoree.modeling.extrapolation.maths.AdjLinearSolverQr;
                        constructor(degree: number) {
                            this.coef = new org.kevoree.modeling.extrapolation.maths.DenseMatrix64F(degree + 1, 1);
                            this.A = new org.kevoree.modeling.extrapolation.maths.DenseMatrix64F(1, degree + 1);
                            this.y = new org.kevoree.modeling.extrapolation.maths.DenseMatrix64F(1, 1);
                            this.solver = new org.kevoree.modeling.extrapolation.maths.AdjLinearSolverQr();
                        }
                    ...
                    export class QRDecompositionHouseholderColumn_D64 {
                        ...
                        public getQ(Q: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F, compact: boolean): org.kevoree.modeling.extrapolation.maths.DenseMatrix64F {
                            if (compact) {
                                if (Q == null) {
                                    Q = org.kevoree.modeling.extrapolation.maths.DenseMatrix64F.identity(this.numRows, this.minLength);
                                } else {
                                    org.kevoree.modeling.extrapolation.maths.DenseMatrix64F.setIdentity(Q);
                                }
                            } else {
                                if (Q == null) {
                                    Q = org.kevoree.modeling.extrapolation.maths.DenseMatrix64F.widentity(this.numRows);
                                } else {
                                    org.kevoree.modeling.extrapolation.maths.DenseMatrix64F.setIdentity(Q);
                                }
                            }
                            for (var j: number = this.minLength - 1; j >= 0; j--) {
                                ...
                                var vv: number = u[j];
                                u[j] = 1;
                                org.kevoree.modeling.extrapolation.maths.QRDecompositionHouseholderColumn_D64.rank1UpdateMultR(Q, u, this.gammas[j], j, j, this.numRows, this.v);
                                u[j] = vv;
                            }
                            return Q;
                        }

                        public getR(R: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F, compact: boolean): org.kevoree.modeling.extrapolation.maths.DenseMatrix64F {
                            if (R == null) {
                                if (compact) {
                                    R = new org.kevoree.modeling.extrapolation.maths.DenseMatrix64F(this.minLength, this.numCols);
                                } else {
                                    R = new org.kevoree.modeling.extrapolation.maths.DenseMatrix64F(this.numRows, this.numCols);
                                }
                            } else {
                        ...
                        public decompose(A: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F): boolean {
                        ...
                        public convertToColumnMajor(A: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F): void {
                        ...
                        public householder(j: number): void {
                            var u: number[] = this.dataQR[j];
                            var max: number = org.kevoree.modeling.extrapolation.maths.QRDecompositionHouseholderColumn_D64.findMax(u, j, this.numRows - j);
                            if (max == 0.0) {
                                this.gamma = 0;
                                this.error = true;
                            } else {
                                this.tau = org.kevoree.modeling.extrapolation.maths.QRDecompositionHouseholderColumn_D64.computeTauAndDivide(j, this.numRows, u, max);
                                var u_0: number = u[j] + this.tau;
                                org.kevoree.modeling.extrapolation.maths.QRDecompositionHouseholderColumn_D64.divideElements(j + 1, this.numRows, u, u_0);
                        ...
                        public static rank1UpdateMultR(A: org.kevoree.modeling.extrapolation.maths.DenseMatrix64F, u: number[], gamma: number, colA0: number, w0: number, w1: number, _temp: number[]): void {
                    ...
                    export module segment {
                        export class HeapCacheSegment implements org.kevoree.modeling.memory.KCacheElementSegment {
                            ...
                            public serialize(metaModel: org.kevoree.modeling.meta.MetaModel): string {
                                return org.kevoree.modeling.memory.manager.JsonRaw.encode(this, org.kevoree.modeling.KConfig.NULL_LONG, metaModel.metaClass(this._metaClassIndex), false);
                            }
