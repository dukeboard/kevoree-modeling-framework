        ...
        export module modeling {
            export module api {
                ...
                export module abs {
                    ...
                    export class AbstractKDefer implements org.kevoree.modeling.api.KDefer {

                        private _isDone: boolean = false;
                        public _isReady: boolean = false;
                        private _nbRecResult: number = 0;
                        private _nbExpectedResult: number = 0;
                        private _nextTasks: java.util.ArrayList<org.kevoree.modeling.api.KDefer> = null;
                        private _results: org.kevoree.modeling.api.map.StringHashMap<any> = null;
                        ...
                        public setDoneOrRegister(next: org.kevoree.modeling.api.KDefer): boolean {
                            if (next != null) {
                                if (this._nextTasks == null) {
                                    this._nextTasks = new java.util.ArrayList<org.kevoree.modeling.api.KDefer>();
                                }
                                ...
                                if (this._nextTasks != null) {
                                    for (var i: number = 0; i < this._nextTasks.size(); i++) {
                                        (<org.kevoree.modeling.api.abs.AbstractKDefer>this._nextTasks.get(i)).informParentEnd(this);
                                    }
                                }
                                return this._isDone;
                            }
                        ...
                        private informParentEnd(end: org.kevoree.modeling.api.KDefer): void {
                            if (end == null) {
                        ...
                        public waitDefer(p_previous: org.kevoree.modeling.api.KDefer): org.kevoree.modeling.api.KDefer {
                            if (p_previous != this) {
                                if (!(<org.kevoree.modeling.api.abs.AbstractKDefer>p_previous).setDoneOrRegister(this)) {
                        ...
                        public next(): org.kevoree.modeling.api.KDefer {
                            var nextTask: org.kevoree.modeling.api.abs.AbstractKDefer = new org.kevoree.modeling.api.abs.AbstractKDefer();
                    ...
                    export class AbstractKModel<A extends org.kevoree.modeling.api.KUniverse<any, any, any>> implements org.kevoree.modeling.api.KModel<any> {
                        ...
                        public internalCreateObject(universe: number, time: number, uuid: number, clazz: org.kevoree.modeling.api.meta.MetaClass): org.kevoree.modeling.api.KObject {
                            throw "Abstract method";
                        }

                        public createProxy(universe: number, time: number, uuid: number, clazz: org.kevoree.modeling.api.meta.MetaClass): org.kevoree.modeling.api.KObject {
                        ...
                        public defer(): org.kevoree.modeling.api.KDefer {
                        ...
                        public create(clazz: org.kevoree.modeling.api.meta.MetaClass, universe: number, time: number): org.kevoree.modeling.api.KObject {
                            if (!org.kevoree.modeling.api.util.Checker.isDefined(clazz)) {
                                return null;
                            }
                            var newObj: org.kevoree.modeling.api.KObject = this.internalCreateObject(universe, time, this._manager.nextObjectKey(), clazz);
                            if (newObj != null) {
                        ...
                        public createByName(metaClassName: string, universe: number, time: number): org.kevoree.modeling.api.KObject {
                    ...
                    export class AbstractKObject implements org.kevoree.modeling.api.KObject {
                        ...
                        public select(query: string, cb: (p : org.kevoree.modeling.api.KObject[]) => void): void {
                            if (!org.kevoree.modeling.api.util.Checker.isDefined(query)) {
                                ...
                                if (query.startsWith("/")) {
                                    ...
                                    this._manager.getRoot(this._universe, this._time,  (rootObj : org.kevoree.modeling.api.KObject) => {
                                        if (rootObj == null) {
                                            cb(new Array());
                                        } else {
                        ...
                        public getByName(atributeName: string): any {
                            var transposed: org.kevoree.modeling.api.meta.MetaAttribute = this._metaClass.attribute(atributeName);
                            if (transposed != null) {
                                return transposed.strategy().extrapolate(this, transposed);
                            } else {
                                return null;
                        ...
                        public internal_mutate(actionType: org.kevoree.modeling.api.KActionType, metaReferenceP: org.kevoree.modeling.api.meta.MetaReference, param: org.kevoree.modeling.api.KObject, setOpposite: boolean): void {
                            ...
                            if (actionType.equals(org.kevoree.modeling.api.KActionType.ADD)) {
                                if (metaReference.single()) {
                                    ...
                                    var raw: org.kevoree.modeling.api.data.cache.KCacheEntry = this._manager.entry(this, org.kevoree.modeling.api.data.manager.AccessMode.WRITE);
                                ...
                                if (actionType.equals(org.kevoree.modeling.api.KActionType.SET)) {
                                    if (!metaReference.single()) {
                                        ...
                                        if (param == null) {
                                            ...
                                            var payload: org.kevoree.modeling.api.data.cache.KCacheEntry = this._manager.entry(this, org.kevoree.modeling.api.data.manager.AccessMode.WRITE);
                                            ...
                                            if (setOpposite) {
                                                if (previous != null) {
                                                    ...
                                                    this._manager.lookupAllobjects(this._universe, this._time, previous,  (kObjects : org.kevoree.modeling.api.KObject[]) => {
                                                        for (var i: number = 0; i < kObjects.length; i++) {
                                                            (<org.kevoree.modeling.api.abs.AbstractKObject>kObjects[i]).internal_mutate(org.kevoree.modeling.api.KActionType.REMOVE, metaReference.opposite(), self, false);
                                                        }
                                                        (<org.kevoree.modeling.api.abs.AbstractKObject>param).internal_mutate(org.kevoree.modeling.api.KActionType.ADD, metaReference.opposite(), self, false);
                                                    });
                                                } else {
                                                    (<org.kevoree.modeling.api.abs.AbstractKObject>param).internal_mutate(org.kevoree.modeling.api.KActionType.ADD, metaReference.opposite(), this, false);
                                                }
                                    ...
                                    if (actionType.equals(org.kevoree.modeling.api.KActionType.REMOVE)) {
                                        if (metaReference.single()) {
                                            ...
                                            if (setOpposite) {
                                                if (previousKid != null) {
                                                    var self: org.kevoree.modeling.api.KObject = this;
                                                    this._manager.lookupAllobjects(this._universe, this._time, previousKid,  (resolvedParams : org.kevoree.modeling.api.KObject[]) => {
                                                        if (resolvedParams != null) {
                                                            for (var dd: number = 0; dd < resolvedParams.length; dd++) {
                                                                if (resolvedParams[dd] != null) {
                                                                    (<org.kevoree.modeling.api.abs.AbstractKObject>resolvedParams[dd]).internal_mutate(org.kevoree.modeling.api.KActionType.REMOVE, metaReference.opposite(), self, false);
                                                                }
                                                            }
                                                        }
                                                    });
                        ...
                        public visit(p_visitor: (p : org.kevoree.modeling.api.KObject) => org.kevoree.modeling.api.KVisitResult, cb: (p : any) => void): void {
                        ...
                        private internal_visit(visitor: (p : org.kevoree.modeling.api.KObject) => org.kevoree.modeling.api.KVisitResult, end: (p : any) => void, visited: org.kevoree.modeling.api.map.LongLongHashMap, traversed: org.kevoree.modeling.api.map.LongLongHashMap): void {
                            if (!org.kevoree.modeling.api.util.Checker.isDefined(visitor)) {
                                return;
                            }
                            if (traversed != null) {
                            ...
                            if (toResolveIds.size() == 0) {
                                ...
                                this._manager.lookupAllobjects(this._universe, this._time, trimmed,  (resolvedArr : org.kevoree.modeling.api.KObject[]) => {
                                    ...
                                    for (var i: number = 0; i < resolvedArr.length; i++) {
                                        ...
                                        var result: org.kevoree.modeling.api.KVisitResult = org.kevoree.modeling.api.KVisitResult.CONTINUE;
                                        if (resolved != null) {
                        ...
                        public jump(p_time: number, p_callback: (p : org.kevoree.modeling.api.KObject) => void): void {
                            ...
                            if (resolve_entry != null) {
                                ...
                                var timeTree: org.kevoree.modeling.api.rbtree.KLongTree = <org.kevoree.modeling.api.rbtree.KLongTree>this._manager.cache().get(this._universe, org.kevoree.modeling.api.KConfig.NULL_LONG, this._uuid);
                                if (timeTree != null) {
                                    var resolvedTime: number = timeTree.previousOrEqual(p_time);
                                    if (resolvedTime != org.kevoree.modeling.api.KConfig.NULL_LONG) {
                                        var entry: org.kevoree.modeling.api.data.cache.KCacheEntry = <org.kevoree.modeling.api.data.cache.KCacheEntry>this._manager.cache().get(this._universe, resolvedTime, this._uuid);
                                        if (entry != null) {
                                            p_callback((<org.kevoree.modeling.api.abs.AbstractKModel<any>>this._manager.model()).createProxy(this._universe, p_time, this._uuid, this._metaClass));
                                        } else {
                        ...
                        public call(p_operation: org.kevoree.modeling.api.meta.MetaOperation, p_params: any[], cb: (p : any) => void): void {
                    ...
                    export class AbstractKUniverse<A extends org.kevoree.modeling.api.KView, B extends org.kevoree.modeling.api.KUniverse<any, any, any>, C extends org.kevoree.modeling.api.KModel<any>> implements org.kevoree.modeling.api.KUniverse<any, any, any> {
                        ...
                        public diverge(): B {
                            var casted: org.kevoree.modeling.api.abs.AbstractKModel<any> = <org.kevoree.modeling.api.abs.AbstractKModel<any>>this._manager.model();
                            var nextKey: number = this._manager.nextUniverseKey();
                        ...
                        public lookupAllTimes(uuid: number, times: number[], cb: (p : org.kevoree.modeling.api.KObject[]) => void): void {
                    ...
                    export class AbstractKView implements org.kevoree.modeling.api.KView {
                        ...
                        public setRoot(elem: org.kevoree.modeling.api.KObject, cb: (p : any) => void): void {
                        ...
                        public lookup(kid: number, cb: (p : org.kevoree.modeling.api.KObject) => void): void {
                            this._manager.lookup(this._universe, this._time, kid, cb);
                        }

                        public lookupAll(keys: number[], cb: (p : org.kevoree.modeling.api.KObject[]) => void): void {
                        ...
                        public json(): org.kevoree.modeling.api.KModelFormat {
                            return new org.kevoree.modeling.api.json.JsonFormat(this._universe, this._time, this._manager);
                        }

                        public xmi(): org.kevoree.modeling.api.KModelFormat {
                    ...
                    export class AbstractMetaReference implements org.kevoree.modeling.api.meta.MetaReference {
                        ...
                        public type(): org.kevoree.modeling.api.meta.MetaClass {
                    ...
                    export class AbstractTimeWalker implements org.kevoree.modeling.api.KTimeWalker {
                        ...
                        private _origin: org.kevoree.modeling.api.abs.AbstractKObject = null;
                        ...
                        private internal_times(start: number, end: number, cb: (p : number[]) => void): void {
                            ...
                            var manager: org.kevoree.modeling.api.data.manager.DefaultKDataManager = <org.kevoree.modeling.api.data.manager.DefaultKDataManager>this._origin._manager;
                            manager.bumpKeysToCache(keys,  (kCacheObjects : org.kevoree.modeling.api.data.cache.KCacheObject[]) => {
                                ...
                                if (kCacheObjects[0] == null || kCacheObjects[1] == null) {
                                    ...
                                    var collectedUniverse: number[] = org.kevoree.modeling.api.data.manager.ResolutionHelper.universeSelectByRange(<org.kevoree.modeling.api.map.LongLongHashMap>kCacheObjects[0], <org.kevoree.modeling.api.map.LongLongHashMap>kCacheObjects[1], start, end, this._origin.universe());
                                    ...
                                    manager.bumpKeysToCache(timeTreeToLoad,  (timeTrees : org.kevoree.modeling.api.data.cache.KCacheObject[]) => {
                                        ...
                                        for (var i: number = 0; i < collectedUniverse.length; i++) {
                                            var timeTree: org.kevoree.modeling.api.rbtree.KLongTree = <org.kevoree.modeling.api.rbtree.KLongTree>timeTrees[i];
                                            if (timeTree != null) {
                ...
                export module data {
                    export module cache {
                        export class HashMemoryCache implements org.kevoree.modeling.api.data.cache.KCache {

                            public elementData: org.kevoree.modeling.api.data.cache.HashMemoryCache.Entry[];
                            ...
                            public get(universe: number, time: number, obj: number): org.kevoree.modeling.api.data.cache.KCacheObject {
                            ...
                            public put(universe: number, time: number, obj: number, payload: org.kevoree.modeling.api.data.cache.KCacheObject): void {
                                var entry: org.kevoree.modeling.api.data.cache.HashMemoryCache.Entry = null;
                                var hash: number = <number>(universe ^ time ^ obj);
                                var index: number = (hash & 0x7FFFFFFF) % this.elementDataSize;
                                if (this.elementDataSize != 0) {
                                    var m: org.kevoree.modeling.api.data.cache.HashMemoryCache.Entry = this.elementData[index];
                            ...
                            private complex_insert(previousIndex: number, hash: number, universe: number, time: number, obj: number): org.kevoree.modeling.api.data.cache.HashMemoryCache.Entry {
                                this.modCount++;
                                var index: number = previousIndex;
                                if (++this.elementCount > this.threshold) {
                                    var length: number = (this.elementDataSize == 0 ? 1 : this.elementDataSize << 1);
                                    var newData: org.kevoree.modeling.api.data.cache.HashMemoryCache.Entry[] = new Array();
                                    for (var i: number = 0; i < this.elementDataSize; i++) {
                                        var entry: org.kevoree.modeling.api.data.cache.HashMemoryCache.Entry = this.elementData[i];
                                        while (entry != null){
                                            index = (<number>(entry.universe ^ entry.time ^ entry.obj) & 0x7FFFFFFF) % length;
                                            var next: org.kevoree.modeling.api.data.cache.HashMemoryCache.Entry = entry.next;
                                ...
                                var entry: org.kevoree.modeling.api.data.cache.HashMemoryCache.Entry = new org.kevoree.modeling.api.data.cache.HashMemoryCache.Entry();
                            ...
                            public dirties(): org.kevoree.modeling.api.data.cache.KCacheDirty[] {
                                ...
                                for (var i: number = 0; i < this.elementDataSize; i++) {
                                    if (this.elementData[i] != null) {
                                        var current: org.kevoree.modeling.api.data.cache.HashMemoryCache.Entry = this.elementData[i];
                                ...
                                var collectedDirties: org.kevoree.modeling.api.data.cache.KCacheDirty[] = new Array();
                                nbDirties = 0;
                                for (var i: number = 0; i < this.elementDataSize; i++) {
                                    if (nbDirties < collectedDirties.length) {
                                        if (this.elementData[i] != null) {
                                            var current: org.kevoree.modeling.api.data.cache.HashMemoryCache.Entry = this.elementData[i];
                                            if (this.elementData[i].value.isDirty()) {
                                                var dirty: org.kevoree.modeling.api.data.cache.KCacheDirty = new org.kevoree.modeling.api.data.cache.KCacheDirty(new org.kevoree.modeling.api.data.cache.KContentKey(current.universe, current.time, current.obj), this.elementData[i].value);
                                            ...
                                            while (current.next != null){
                                                current = current.next;
                                                if (current.value.isDirty()) {
                                                    var dirty: org.kevoree.modeling.api.data.cache.KCacheDirty = new org.kevoree.modeling.api.data.cache.KCacheDirty(new org.kevoree.modeling.api.data.cache.KContentKey(current.universe, current.time, current.obj), current.value);
                                                    collectedDirties[nbDirties] = dirty;
                        ...
                        export module HashMemoryCache { 
                            export class Entry {
                                ...
                                public next: org.kevoree.modeling.api.data.cache.HashMemoryCache.Entry;
                                public universe: number;
                                public time: number;
                                public obj: number;
                                public value: org.kevoree.modeling.api.data.cache.KCacheObject;
                            }
                        ...
                        export class KContentKey {
                            ...
                            public equals(param: any): boolean {
                                if (param instanceof org.kevoree.modeling.api.data.cache.KContentKey) {
                                    var remote: org.kevoree.modeling.api.data.cache.KContentKey = <org.kevoree.modeling.api.data.cache.KContentKey>param;
                    ...
                    export module manager {
                        ...
                        export class DefaultKDataManager implements org.kevoree.modeling.api.data.manager.KDataManager {
                            ...
                            private _cache: org.kevoree.modeling.api.data.cache.KCache;
                            ...
                            public globalUniverseOrder(): org.kevoree.modeling.api.map.LongLongHashMap {
                                return <org.kevoree.modeling.api.map.LongLongHashMap>this._cache.get(org.kevoree.modeling.api.KConfig.NULL_LONG, org.kevoree.modeling.api.KConfig.NULL_LONG, org.kevoree.modeling.api.KConfig.NULL_LONG);
                            }
                            ...
                            public initKObject(obj: org.kevoree.modeling.api.KObject): void {
                                ...
                                cacheEntry.inc();
                                var timeTree: org.kevoree.modeling.api.rbtree.ooheap.OOKLongTree = new org.kevoree.modeling.api.rbtree.ooheap.OOKLongTree();
                                timeTree.inc();
                                                        ...
                                                        if (errorL2 != null) {
                                                            ...
                                                            if (strings.length == 3) {
                                                                ...
                                                                try {
                                                                    ...
                                                                    this._cache.put(org.kevoree.modeling.api.KConfig.NULL_LONG, org.kevoree.modeling.api.KConfig.NULL_LONG, org.kevoree.modeling.api.KConfig.NULL_LONG, globalUniverseTree);
                            ...
                            public entry(origin: org.kevoree.modeling.api.KObject, accessMode: org.kevoree.modeling.api.data.manager.AccessMode): org.kevoree.modeling.api.data.cache.KCacheEntry {
                                var currentEntry: org.kevoree.modeling.api.data.cache.KCacheEntry = <org.kevoree.modeling.api.data.cache.KCacheEntry>this._cache.get(origin.universe(), origin.now(), origin.uuid());
                                if (currentEntry != null) {
                                    return currentEntry;
                                }
                                var objectUniverseTree: org.kevoree.modeling.api.map.LongLongHashMap = <org.kevoree.modeling.api.map.LongLongHashMap>this._cache.get(org.kevoree.modeling.api.KConfig.NULL_LONG, org.kevoree.modeling.api.KConfig.NULL_LONG, origin.uuid());
                                var resolvedUniverse: number = org.kevoree.modeling.api.data.manager.ResolutionHelper.resolve_universe(this.globalUniverseOrder(), objectUniverseTree, origin.now(), origin.universe());
                                var timeTree: org.kevoree.modeling.api.rbtree.KLongTree = <org.kevoree.modeling.api.rbtree.KLongTree>this._cache.get(resolvedUniverse, org.kevoree.modeling.api.KConfig.NULL_LONG, origin.uuid());
                                if (timeTree == null) {
                                ...
                                if (resolvedTime != org.kevoree.modeling.api.KConfig.NULL_LONG) {
                                    ...
                                    var needUniverseCopy: boolean = accessMode.equals(org.kevoree.modeling.api.data.manager.AccessMode.WRITE) && (resolvedUniverse != origin.universe());
                                    var entry: org.kevoree.modeling.api.data.cache.KCacheEntry = <org.kevoree.modeling.api.data.cache.KCacheEntry>this._cache.get(resolvedUniverse, resolvedTime, origin.uuid());
                                    if (entry == null) {
                                        return null;
                                    }
                                    ...
                                    if (!needTimeCopy && !needUniverseCopy) {
                                        ...
                                        if (!needUniverseCopy) {
                                            ...
                                            var newTemporalTree: org.kevoree.modeling.api.rbtree.ooheap.OOKLongTree = new org.kevoree.modeling.api.rbtree.ooheap.OOKLongTree();
                            ...
                            public lookup(universe: number, time: number, uuid: number, callback: (p : org.kevoree.modeling.api.KObject) => void): void {
                                var keys: number[] = new Array();
                                keys[0] = uuid;
                                this.lookupAllobjects(universe, time, keys,  (kObjects : org.kevoree.modeling.api.KObject[]) => {
                            ...
                            public lookupAllobjects(universe: number, time: number, uuids: number[], callback: (p : org.kevoree.modeling.api.KObject[]) => void): void {
                                this._scheduler.dispatch(new org.kevoree.modeling.api.data.manager.LookupAllRunnable(universe, time, uuids, callback, this));
                            }

                            public lookupAlltimes(universe: number, time: number[], uuid: number, callback: (p : org.kevoree.modeling.api.KObject[]) => void): void {
                                throw new java.lang.RuntimeException("Not Implemented Yet !");
                            }
                            ...
                            public getRoot(universe: number, time: number, callback: (p : org.kevoree.modeling.api.KObject) => void): void {
                                this.bumpKeyToCache(org.kevoree.modeling.api.data.cache.KContentKey.createRootUniverseTree(),  (rootGlobalUniverseIndex : org.kevoree.modeling.api.data.cache.KCacheObject) => {
                                    if (rootGlobalUniverseIndex == null) {
                                        ...
                                        var closestUniverse: number = org.kevoree.modeling.api.data.manager.ResolutionHelper.resolve_universe(this.globalUniverseOrder(), <org.kevoree.modeling.api.map.LongLongHashMap>rootGlobalUniverseIndex, time, universe);
                                        ...
                                        this.bumpKeyToCache(universeTreeRootKey,  (universeTree : org.kevoree.modeling.api.data.cache.KCacheObject) => {
                                            if (universeTree == null) {
                                                ...
                                                var resolvedVal: number = (<org.kevoree.modeling.api.rbtree.ooheap.OOKLongLongTree>universeTree).previousOrEqualValue(time);
                            ...
                            public setRoot(newRoot: org.kevoree.modeling.api.KObject, callback: (p : java.lang.Throwable) => void): void {
                                this.bumpKeyToCache(org.kevoree.modeling.api.data.cache.KContentKey.createRootUniverseTree(),  (globalRootTree : org.kevoree.modeling.api.data.cache.KCacheObject) => {
                                    ...
                                    if (cleanedTree == null) {
                                        ...
                                        this._cache.put(org.kevoree.modeling.api.KConfig.NULL_LONG, org.kevoree.modeling.api.KConfig.NULL_LONG, org.kevoree.modeling.api.KConfig.END_OF_TIME, cleanedTree);
                                    }
                                    var closestUniverse: number = org.kevoree.modeling.api.data.manager.ResolutionHelper.resolve_universe(this.globalUniverseOrder(), cleanedTree, newRoot.now(), newRoot.universe());
                                    cleanedTree.put(newRoot.universe(), newRoot.now());
                                    if (closestUniverse != newRoot.universe()) {
                                        var newTimeTree: org.kevoree.modeling.api.rbtree.KLongLongTree = new org.kevoree.modeling.api.rbtree.ooheap.OOKLongLongTree();
                                        newTimeTree.insert(newRoot.now(), newRoot.uuid());
                                        var universeTreeRootKey: org.kevoree.modeling.api.data.cache.KContentKey = org.kevoree.modeling.api.data.cache.KContentKey.createRootTimeTree(newRoot.universe());
                                        this._cache.put(universeTreeRootKey.universe, universeTreeRootKey.time, universeTreeRootKey.obj, <org.kevoree.modeling.api.data.cache.KCacheObject>newTimeTree);
                                        if (callback != null) {
                                            callback(null);
                                        }
                                    } else {
                                        ...
                                        this.bumpKeyToCache(universeTreeRootKey,  (resolvedRootTimeTree : org.kevoree.modeling.api.data.cache.KCacheObject) => {
                                            var initializedTree: org.kevoree.modeling.api.rbtree.KLongLongTree = <org.kevoree.modeling.api.rbtree.KLongLongTree>resolvedRootTimeTree;
                                            if (initializedTree == null) {
                                                initializedTree = new org.kevoree.modeling.api.rbtree.ooheap.OOKLongLongTree();
                                                this._cache.put(universeTreeRootKey.universe, universeTreeRootKey.time, universeTreeRootKey.obj, <org.kevoree.modeling.api.data.cache.KCacheObject>initializedTree);
                                            }
                            ...
                            public reload(keys: org.kevoree.modeling.api.data.cache.KContentKey[], callback: (p : java.lang.Throwable) => void): void {
                                ...
                                for (var i: number = 0; i < keys.length; i++) {
                                    var cached: org.kevoree.modeling.api.data.cache.KCacheObject = this._cache.get(keys[i].universe, keys[i].time, keys[i].obj);
                                    ...
                                    if (error != null) {
                                        ...
                                        for (var i: number = 0; i < strings.length; i++) {
                                            if (strings[i] != null) {
                                                ...
                                                var cachedObj: org.kevoree.modeling.api.data.cache.KCacheObject = this._cache.get(correspondingKey.universe, correspondingKey.time, correspondingKey.obj);
                            ...
                            public bumpKeyToCache(contentKey: org.kevoree.modeling.api.data.cache.KContentKey, callback: (p : org.kevoree.modeling.api.data.cache.KCacheObject) => void): void {
                                var cached: org.kevoree.modeling.api.data.cache.KCacheObject = this._cache.get(contentKey.universe, contentKey.time, contentKey.obj);
                                if (cached != null) {
                                    callback(cached);
                                } else {
                                    var keys: org.kevoree.modeling.api.data.cache.KContentKey[] = new Array();
                            ...
                            private internal_unserialize(key: org.kevoree.modeling.api.data.cache.KContentKey, payload: string): org.kevoree.modeling.api.data.cache.KCacheObject {
                                ...
                                var isUniverseNotNull: boolean = key.universe != org.kevoree.modeling.api.KConfig.NULL_LONG;
                                if (org.kevoree.modeling.api.KConfig.END_OF_TIME == key.obj) {
                                    ...
                                    var isTimeNotNull: boolean = key.time != org.kevoree.modeling.api.KConfig.NULL_LONG;
                                    var isObjNotNull: boolean = key.obj != org.kevoree.modeling.api.KConfig.NULL_LONG;
                                ...
                                this._store.bumpKeysToCache(tempKeys,  (universeIndexes : org.kevoree.modeling.api.data.cache.KCacheObject[]) => {
                                    for (var i: number = 0; i < this._keys.length; i++) {
                                        ...
                                        if (universeIndexes[i] != null) {
                                            var closestUniverse: number = org.kevoree.modeling.api.data.manager.ResolutionHelper.resolve_universe(this._store.globalUniverseOrder(), <org.kevoree.modeling.api.map.LongLongHashMap>universeIndexes[i], this._time, this._universe);
                                    ...
                                    this._store.bumpKeysToCache(tempKeys,  (timeIndexes : org.kevoree.modeling.api.data.cache.KCacheObject[]) => {
                                        for (var i: number = 0; i < this._keys.length; i++) {
                                            ...
                                            if (timeIndexes[i] != null) {
                                                var cachedIndexTree: org.kevoree.modeling.api.rbtree.KLongTree = <org.kevoree.modeling.api.rbtree.KLongTree>timeIndexes[i];
                                                ...
                                                if (resolvedNode != org.kevoree.modeling.api.KConfig.NULL_LONG) {
                                                    resolvedContentKey = org.kevoree.modeling.api.data.cache.KContentKey.createObject(tempKeys[i].universe, resolvedNode, this._keys[i]);
                                                }
                                            }
                                        ...
                                        this._store.bumpKeysToCache(tempKeys,  (cachedObjects : org.kevoree.modeling.api.data.cache.KCacheObject[]) => {
                                            ...
                                            for (var i: number = 0; i < this._keys.length; i++) {
                                                if (cachedObjects[i] != null && cachedObjects[i] instanceof org.kevoree.modeling.api.data.cache.KCacheEntry) {
                                                    proxies[i] = (<org.kevoree.modeling.api.abs.AbstractKModel<any>>this._store.model()).createProxy(this._universe, this._time, this._keys[i], (<org.kevoree.modeling.api.data.cache.KCacheEntry>cachedObjects[i]).metaClass);
                                                    if (proxies[i] != null) {
                                                        var cachedIndexTree: org.kevoree.modeling.api.rbtree.KLongTree = <org.kevoree.modeling.api.rbtree.KLongTree>timeIndexes[i];
                                                        cachedObjects[i].inc();
                                                        (<org.kevoree.modeling.api.data.cache.KCacheObject>cachedIndexTree).inc();
                                                    }
                                                }
                                            }
                ...
                export module event {
                    export class LocalEventListeners {
                        ...
                        public registerListenerAll(groupId: number, universe: number, objects: number[], listener: (p : org.kevoree.modeling.api.KObject[]) => void): void {
                            var generateNewID: number = this._internalListenerKeyGen.nextKey();
                                        ...
                                        for (var i: number = 0; i < messages.size(); i++) {
                                            if (kCacheObjects[i] != null && kCacheObjects[i] instanceof org.kevoree.modeling.api.data.cache.KCacheEntry) {
                                                ...
                                                if (listeners != null) {
                                                    ...
                                                    var toDispatch: org.kevoree.modeling.api.KObject = (<org.kevoree.modeling.api.abs.AbstractKModel<any>>this._manager.model()).createProxy(correspondingKey.universe, correspondingKey.time, correspondingKey.obj, (<org.kevoree.modeling.api.data.cache.KCacheEntry>kCacheObjects[i]).metaClass);
                                                    if (toDispatch != null) {
                                                        kCacheObjects[i].inc();
                                                    }
                ...
                export module extrapolation {
                    export class DiscreteExtrapolation implements org.kevoree.modeling.api.extrapolation.Extrapolation {
                        ...
                        public extrapolate(current: org.kevoree.modeling.api.KObject, attribute: org.kevoree.modeling.api.meta.MetaAttribute): any {
                            var payload: org.kevoree.modeling.api.data.cache.KCacheEntry = (<org.kevoree.modeling.api.abs.AbstractKObject>current)._manager.entry(current, org.kevoree.modeling.api.data.manager.AccessMode.READ);
                            if (payload != null) {
                        ...
                        public mutate(current: org.kevoree.modeling.api.KObject, attribute: org.kevoree.modeling.api.meta.MetaAttribute, payload: any): void {
                            var internalPayload: org.kevoree.modeling.api.data.cache.KCacheEntry = (<org.kevoree.modeling.api.abs.AbstractKObject>current)._manager.entry(current, org.kevoree.modeling.api.data.manager.AccessMode.WRITE);
                    ...
                    export class PolynomialExtrapolation implements org.kevoree.modeling.api.extrapolation.Extrapolation {
                        ...
                        public extrapolate(current: org.kevoree.modeling.api.KObject, attribute: org.kevoree.modeling.api.meta.MetaAttribute): any {
                            var pol: org.kevoree.modeling.api.polynomial.PolynomialModel = <org.kevoree.modeling.api.polynomial.PolynomialModel>(<org.kevoree.modeling.api.abs.AbstractKObject>current)._manager.entry(current, org.kevoree.modeling.api.data.manager.AccessMode.READ).get(attribute.index());
                            if (pol != null) {
                        ...
                        public mutate(current: org.kevoree.modeling.api.KObject, attribute: org.kevoree.modeling.api.meta.MetaAttribute, payload: any): void {
                            var raw: org.kevoree.modeling.api.data.cache.KCacheEntry = (<org.kevoree.modeling.api.abs.AbstractKObject>current)._manager.entry(current, org.kevoree.modeling.api.data.manager.AccessMode.READ);
                            ...
                            if (previous == null) {
                                ...
                                (<org.kevoree.modeling.api.abs.AbstractKObject>current)._manager.entry(current, org.kevoree.modeling.api.data.manager.AccessMode.WRITE).set(attribute.index(), pol);
                            } else {
                ...
                export module json {
                    export class JsonFormat implements org.kevoree.modeling.api.KModelFormat {
                        ...
                        public save(model: org.kevoree.modeling.api.KObject, cb: (p : string) => void): void {
                        ...
                        public saveRoot(cb: (p : string) => void): void {
                            if (org.kevoree.modeling.api.util.Checker.isDefined(cb)) {
                                this._manager.getRoot(this._universe, this._time,  (root : org.kevoree.modeling.api.KObject) => {
                                    if (root == null) {
                                        cb(null);
                                    } else {
                    ...
                    export class JsonModelLoader {
                        ...
                        public static load(manager: org.kevoree.modeling.api.data.manager.KDataManager, universe: number, time: number, payload: string, callback: (p : java.lang.Throwable) => void): void {
                             if (payload == null) {
                             callback(null);
                             } else {
                        ...
                        private static loadObj(p_param: org.kevoree.modeling.api.map.StringHashMap<any>, manager: org.kevoree.modeling.api.data.manager.KDataManager, universe: number, time: number, p_mappedKeys: org.kevoree.modeling.api.map.LongLongHashMap, p_rootElem: org.kevoree.modeling.api.KObject[]): void {
                            ...
                            var metaClass: org.kevoree.modeling.api.meta.MetaClass = manager.model().metaModel().metaClass(meta);
                            var current: org.kevoree.modeling.api.KObject = (<org.kevoree.modeling.api.abs.AbstractKModel<any>>manager.model()).createProxy(universe, time, p_mappedKeys.get(kid), metaClass);
                            manager.initKObject(current);
                            var raw: org.kevoree.modeling.api.data.cache.KCacheEntry = manager.entry(current, org.kevoree.modeling.api.data.manager.AccessMode.WRITE);
                            p_param.each( (metaKey : string, payload_content : any) => {
                                if (metaKey.equals(org.kevoree.modeling.api.json.JsonFormat.KEY_ROOT)) {
                                    ...
                                    if (payload_content != null) {
                                        if (metaElement != null && metaElement.metaType().equals(org.kevoree.modeling.api.meta.MetaType.ATTRIBUTE)) {
                                            raw.set(metaElement.index(), (<org.kevoree.modeling.api.meta.MetaAttribute>metaElement).strategy().load(payload_content.toString(), <org.kevoree.modeling.api.meta.MetaAttribute>metaElement, time));
                                        } else {
                                            if (metaElement != null && metaElement instanceof org.kevoree.modeling.api.abs.AbstractMetaReference) {
                                                try {
                    ...
                    export class JsonModelSerializer {
                        ...
                        public static serialize(model: org.kevoree.modeling.api.KObject, callback: (p : string) => void): void {
                            (<org.kevoree.modeling.api.abs.AbstractKObject>model)._manager.getRoot(model.universe(), model.now(),  (rootObj : org.kevoree.modeling.api.KObject) => {
                        ...
                        public static printJSON(elem: org.kevoree.modeling.api.KObject, builder: java.lang.StringBuilder, isRoot: boolean): void {
                            if (elem != null) {
                                var raw: org.kevoree.modeling.api.data.cache.KCacheEntry = (<org.kevoree.modeling.api.abs.AbstractKObject>elem)._manager.entry(elem, org.kevoree.modeling.api.data.manager.AccessMode.READ);
                                if (raw != null) {
                ...
                export module rbtree {
                    export interface KLongLongTree extends org.kevoree.modeling.api.rbtree.KTree {
                    ...
                    export interface KLongTree extends org.kevoree.modeling.api.rbtree.KTree {
                    ...
                    export interface KTree extends org.kevoree.modeling.api.data.cache.KCacheObject {
                    ...
                    export module ooheap {
                        export class LongTreeNode {
                            ...
                            private left: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode;
                            private right: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode;
                            private parent: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = null;
                            ...
                            public grandparent(): org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode {
                                if (this.parent != null) {
                            ...
                            public sibling(): org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode {
                                if (this.parent == null) {
                                    return null;
                                } else {
                            ...
                            public uncle(): org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode {
                                if (this.parent != null) {
                            ...
                            public getLeft(): org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode {
                                return this.left;
                            }

                            public setLeft(left: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode): void {
                                this.left = left;
                            }

                            public getRight(): org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode {
                                return this.right;
                            }

                            public setRight(right: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode): void {
                                this.right = right;
                            }

                            public getParent(): org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode {
                                return this.parent;
                            }

                            public setParent(parent: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode): void {
                                this.parent = parent;
                            }
                            ...
                            public next(): org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode {
                                var p: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = this;
                                if (p.right != null) {
                                    p = p.right;
                                    while (p.left != null){
                                        p = p.left;
                            ...
                            public previous(): org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode {
                                var p: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = this;
                                if (p.left != null) {
                                    p = p.left;
                                    while (p.right != null){
                            ...
                            public static unserialize(ctx: org.kevoree.modeling.api.rbtree.ooheap.TreeReaderContext): org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode {
                                return org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode.internal_unserialize(true, ctx);
                            }

                            public static internal_unserialize(rightBranch: boolean, ctx: org.kevoree.modeling.api.rbtree.ooheap.TreeReaderContext): org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode {
                                ...
                                var p: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = new org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode(key, value, colorLoaded, null, null);
                                var left: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode.internal_unserialize(false, ctx);
                                if (left != null) {
                                    left.setParent(p);
                                }
                                var right: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode.internal_unserialize(true, ctx);
                                if (right != null) {
                                    right.setParent(p);
                                }
                                p.setLeft(left);
                        ...
                        export class OOKLongLongTree implements org.kevoree.modeling.api.data.cache.KCacheObject, org.kevoree.modeling.api.rbtree.KLongLongTree {

                            private root: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = null;
                            private _size: number = 0;
                            public _dirty: boolean = false;
                            private _counter: number = 0;
                            private _previousOrEqualsCacheValues: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode[] = null;
                            private _previousOrEqualsNextCacheElem: number;
                            private _lookupCacheValues: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode[] = null;
                            ...
                            private tryPreviousOrEqualsCache(key: number): org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode {
                            ...
                            private tryLookupCache(key: number): org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode {
                            ...
                            private putInPreviousOrEqualsCache(resolved: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode): void {
                            ...
                            private putInLookupCache(resolved: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode): void {
                            ...
                            public unserialize(key: org.kevoree.modeling.api.data.cache.KContentKey, payload: string, metaModel: org.kevoree.modeling.api.meta.MetaModel): void {
                                ...
                                var ctx: org.kevoree.modeling.api.rbtree.ooheap.TreeReaderContext = new org.kevoree.modeling.api.rbtree.ooheap.TreeReaderContext();
                                ctx.index = i;
                                ctx.payload = payload;
                            ...
                            public lookupValue(key: number): number {
                                var result: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = this.internal_lookup(key);
                                if (result != null) {
                                    return result.value;
                                } else {
                                    return org.kevoree.modeling.api.KConfig.NULL_LONG;
                            ...
                            private internal_lookup(key: number): org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode {
                                var n: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = this.tryLookupCache(key);
                                if (n != null) {
                                    return n;
                                }
                                n = this.root;
                            ...
                            public previousOrEqualValue(key: number): number {
                                var result: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = this.internal_previousOrEqual(key);
                                if (result != null) {
                                    return result.value;
                                } else {
                                    return org.kevoree.modeling.api.KConfig.NULL_LONG;
                            ...
                            private internal_previousOrEqual(key: number): org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode {
                                var p: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = this.tryPreviousOrEqualsCache(key);
                                if (p != null) {
                                    return p;
                                }
                                p = this.root;
                                ...
                                while (p != null){
                                    ...
                                    if (key > p.key) {
                                        ...
                                        if (p.getLeft() != null) {
                                            ...
                                            var parent: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = p.getParent();
                                            var ch: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = p;
                            ...
                            public nextOrEqual(key: number): org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode {
                                var p: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = this.root;
                                if (p == null) {
                                    return null;
                                }
                                while (p != null){
                            ...
                            public previous(key: number): org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode {
                                var p: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = this.root;
                                if (p == null) {
                                    return null;
                                }
                            ...
                            public next(key: number): org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode {
                                var p: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = this.root;
                                if (p == null) {
                                    return null;
                                }
                            ...
                            public first(): org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode {
                                var p: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = this.root;
                                if (p == null) {
                                    return null;
                                }
                            ...
                            public last(): org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode {
                                var p: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = this.root;
                                if (p == null) {
                                    return null;
                                }
                            ...
                            private rotateLeft(n: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode): void {
                                var r: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = n.getRight();
                            ...
                            private rotateRight(n: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode): void {
                                var l: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = n.getLeft();
                            ...
                            private replaceNode(oldn: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode, newn: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode): void {
                            ...
                            public insert(key: number, value: number): void {
                                this.resetCache();
                                this._dirty = true;
                                var insertedNode: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = new org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode(key, value, false, null, null);
                                if (this.root == null) {
                                    this._size++;
                                    this.root = insertedNode;
                                } else {
                                    var n: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = this.root;
                                    while (true){
                                        if (key == n.key) {
                                            n.value = value;
                                            return;
                            ...
                            private insertCase1(n: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode): void {
                                if (n.getParent() == null) {
                                    n.color = true;
                                } else {
                                    this.insertCase2(n);
                            ...
                            private insertCase2(n: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode): void {
                            ...
                            private insertCase3(n: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode): void {
                            ...
                            private insertCase4(n_n: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode): void {
                                var n: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = n_n;
                            ...
                            private insertCase5(n: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode): void {
                                n.getParent().color = true;
                                n.grandparent().color = false;
                            ...
                            public delete(key: number): void {
                                var n: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = this.internal_lookup(key);
                                if (n == null) {
                                    return;
                                } else {
                                    this._size--;
                                    if (n.getLeft() != null && n.getRight() != null) {
                                        var pred: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode = n.getLeft();
                                    ...
                                    var child: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode;
                                    if (n.getRight() == null) {
                                        child = n.getLeft();
                                    } else {
                                        child = n.getRight();
                            ...
                            private deleteCase1(n: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode): void {
                                if (n.getParent() == null) {
                                    return;
                                } else {
                                    this.deleteCase2(n);
                            ...
                            private deleteCase2(n: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode): void {
                            ...
                            private deleteCase3(n: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode): void {
                            ...
                            private deleteCase4(n: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode): void {
                            ...
                            private deleteCase5(n: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode): void {
                            ...
                            private deleteCase6(n: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode): void {
                            ...
                            private nodeColor(n: org.kevoree.modeling.api.rbtree.ooheap.LongTreeNode): boolean {
                                if (n == null) {
                                    return true;
                                } else {
                                    return n.color;
                        ...
                        export class OOKLongTree implements org.kevoree.modeling.api.data.cache.KCacheObject, org.kevoree.modeling.api.rbtree.KLongTree {

                            private _size: number = 0;
                            private root: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = null;
                            private _previousOrEqualsCacheValues: org.kevoree.modeling.api.rbtree.ooheap.TreeNode[] = null;
                            ...
                            private tryPreviousOrEqualsCache(key: number): org.kevoree.modeling.api.rbtree.ooheap.TreeNode {
                                if (this._previousOrEqualsCacheValues != null) {
                            ...
                            private putInPreviousOrEqualsCache(resolved: org.kevoree.modeling.api.rbtree.ooheap.TreeNode): void {
                            ...
                            public previousOrEqual(key: number): number {
                                var resolvedNode: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = this.internal_previousOrEqual(key);
                            ...
                            public internal_previousOrEqual(key: number): org.kevoree.modeling.api.rbtree.ooheap.TreeNode {
                                var cachedVal: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = this.tryPreviousOrEqualsCache(key);
                                if (cachedVal != null) {
                                    return cachedVal;
                                }
                                var p: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = this.root;
                                if (p == null) {
                                    return null;
                                }
                                while (p != null){
                                    ...
                                    if (key > p.key) {
                                        ...
                                        if (p.getLeft() != null) {
                                            ...
                                            var parent: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = p.getParent();
                                            var ch: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = p;
                                            while (parent != null && ch == parent.getLeft()){
                                                ch = parent;
                                                parent = parent.getParent();
                                            }
                            ...
                            public nextOrEqual(key: number): org.kevoree.modeling.api.rbtree.ooheap.TreeNode {
                                var p: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = this.root;
                                if (p == null) {
                                    return null;
                                }
                            ...
                            public previous(key: number): org.kevoree.modeling.api.rbtree.ooheap.TreeNode {
                                var p: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = this.root;
                                if (p == null) {
                                    return null;
                                }
                            ...
                            public next(key: number): org.kevoree.modeling.api.rbtree.ooheap.TreeNode {
                                var p: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = this.root;
                                if (p == null) {
                                    return null;
                                }
                            ...
                            public first(): org.kevoree.modeling.api.rbtree.ooheap.TreeNode {
                                var p: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = this.root;
                                if (p == null) {
                                    return null;
                                }
                            ...
                            public last(): org.kevoree.modeling.api.rbtree.ooheap.TreeNode {
                                var p: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = this.root;
                                if (p == null) {
                                    return null;
                                }
                            ...
                            public lookup(key: number): number {
                                var n: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = this.root;
                                if (n == null) {
                                    return org.kevoree.modeling.api.KConfig.NULL_LONG;
                                }
                                while (n != null){
                            ...
                            public range(start: number, end: number, walker: (p : number) => void): void {
                                var it: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = this.internal_previousOrEqual(end);
                            ...
                            private rotateLeft(n: org.kevoree.modeling.api.rbtree.ooheap.TreeNode): void {
                                var r: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = n.getRight();
                                this.replaceNode(n, r);
                                n.setRight(r.getLeft());
                                if (r.getLeft() != null) {
                                    r.getLeft().setParent(n);
                            ...
                            private rotateRight(n: org.kevoree.modeling.api.rbtree.ooheap.TreeNode): void {
                                var l: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = n.getLeft();
                                this.replaceNode(n, l);
                                n.setLeft(l.getRight());
                                if (l.getRight() != null) {
                                    l.getRight().setParent(n);
                            ...
                            private replaceNode(oldn: org.kevoree.modeling.api.rbtree.ooheap.TreeNode, newn: org.kevoree.modeling.api.rbtree.ooheap.TreeNode): void {
                                if (oldn.getParent() == null) {
                                    this.root = newn;
                                } else {
                                    if (oldn == oldn.getParent().getLeft()) {
                            ...
                            public insert(key: number): void {
                                this._dirty = true;
                                var insertedNode: org.kevoree.modeling.api.rbtree.ooheap.TreeNode;
                                if (this.root == null) {
                                    this._size++;
                            ...
                            private insertCase1(n: org.kevoree.modeling.api.rbtree.ooheap.TreeNode): void {
                                if (n.getParent() == null) {
                                    n.color = true;
                                } else {
                                    this.insertCase2(n);
                            ...
                            private insertCase2(n: org.kevoree.modeling.api.rbtree.ooheap.TreeNode): void {
                                if (this.nodeColor(n.getParent()) == true) {
                                    return;
                                } else {
                                    this.insertCase3(n);
                            ...
                            private insertCase3(n: org.kevoree.modeling.api.rbtree.ooheap.TreeNode): void {
                                if (this.nodeColor(n.uncle()) == false) {
                                    n.getParent().color = true;
                                    n.uncle().color = true;
                                    n.grandparent().color = false;
                            ...
                            private insertCase4(n_n: org.kevoree.modeling.api.rbtree.ooheap.TreeNode): void {
                                var n: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = n_n;
                                if (n == n.getParent().getRight() && n.getParent() == n.grandparent().getLeft()) {
                                    this.rotateLeft(n.getParent());
                                    n = n.getLeft();
                                } else {
                            ...
                            private insertCase5(n: org.kevoree.modeling.api.rbtree.ooheap.TreeNode): void {
                                n.getParent().color = true;
                                n.grandparent().color = false;
                                if (n == n.getParent().getLeft() && n.getParent() == n.grandparent().getLeft()) {
                                    this.rotateRight(n.grandparent());
                            ...
                            public delete(key: number): void {
                                var n: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = null;
                                var nn: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = this.root;
                                while (nn != null){
                                    if (key == nn.key) {
                                        n = nn;
                                    } else {
                                ...
                                if (n == null) {
                                    ...
                                    this._size--;
                                    if (n.getLeft() != null && n.getRight() != null) {
                                        var pred: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = n.getLeft();
                                        while (pred.getRight() != null){
                                            pred = pred.getRight();
                                        }
                                        n.key = pred.key;
                                    ...
                                    var child: org.kevoree.modeling.api.rbtree.ooheap.TreeNode;
                                    if (n.getRight() == null) {
                                        child = n.getLeft();
                                    } else {
                                        child = n.getRight();
                            ...
                            private deleteCase1(n: org.kevoree.modeling.api.rbtree.ooheap.TreeNode): void {
                                if (n.getParent() == null) {
                                    return;
                                } else {
                                    this.deleteCase2(n);
                            ...
                            private deleteCase2(n: org.kevoree.modeling.api.rbtree.ooheap.TreeNode): void {
                                if (this.nodeColor(n.sibling()) == false) {
                                    n.getParent().color = false;
                                    n.sibling().color = true;
                                    if (n == n.getParent().getLeft()) {
                            ...
                            private deleteCase3(n: org.kevoree.modeling.api.rbtree.ooheap.TreeNode): void {
                                if (this.nodeColor(n.getParent()) == true && this.nodeColor(n.sibling()) == true && this.nodeColor(n.sibling().getLeft()) == true && this.nodeColor(n.sibling().getRight()) == true) {
                                    n.sibling().color = false;
                                    this.deleteCase1(n.getParent());
                                } else {
                            ...
                            private deleteCase4(n: org.kevoree.modeling.api.rbtree.ooheap.TreeNode): void {
                                if (this.nodeColor(n.getParent()) == false && this.nodeColor(n.sibling()) == true && this.nodeColor(n.sibling().getLeft()) == true && this.nodeColor(n.sibling().getRight()) == true) {
                                    n.sibling().color = false;
                                    n.getParent().color = true;
                                } else {
                            ...
                            private deleteCase5(n: org.kevoree.modeling.api.rbtree.ooheap.TreeNode): void {
                                if (n == n.getParent().getLeft() && this.nodeColor(n.sibling()) == true && this.nodeColor(n.sibling().getLeft()) == false && this.nodeColor(n.sibling().getRight()) == true) {
                                    n.sibling().color = false;
                                    n.sibling().getLeft().color = true;
                                    this.rotateRight(n.sibling());
                            ...
                            private deleteCase6(n: org.kevoree.modeling.api.rbtree.ooheap.TreeNode): void {
                                n.sibling().color = this.nodeColor(n.getParent());
                                n.getParent().color = true;
                                if (n == n.getParent().getLeft()) {
                                    n.sibling().getRight().color = true;
                            ...
                            private nodeColor(n: org.kevoree.modeling.api.rbtree.ooheap.TreeNode): boolean {
                                if (n == null) {
                                    return true;
                                } else {
                                    return n.color;
                        ...
                        export class TreeNode {
                            ...
                            public key: number;
                            public color: boolean;
                            private left: org.kevoree.modeling.api.rbtree.ooheap.TreeNode;
                            private right: org.kevoree.modeling.api.rbtree.ooheap.TreeNode;
                            private parent: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = null;
                            ...
                            public grandparent(): org.kevoree.modeling.api.rbtree.ooheap.TreeNode {
                                if (this.parent != null) {
                                    return this.parent.parent;
                                } else {
                                    return null;
                            ...
                            public sibling(): org.kevoree.modeling.api.rbtree.ooheap.TreeNode {
                                if (this.parent == null) {
                                    return null;
                                } else {
                                    if (this == this.parent.left) {
                            ...
                            public uncle(): org.kevoree.modeling.api.rbtree.ooheap.TreeNode {
                                if (this.parent != null) {
                                    return this.parent.sibling();
                                } else {
                                    return null;
                            ...
                            public getLeft(): org.kevoree.modeling.api.rbtree.ooheap.TreeNode {
                                return this.left;
                            }

                            public setLeft(left: org.kevoree.modeling.api.rbtree.ooheap.TreeNode): void {
                                this.left = left;
                            }

                            public getRight(): org.kevoree.modeling.api.rbtree.ooheap.TreeNode {
                                return this.right;
                            }

                            public setRight(right: org.kevoree.modeling.api.rbtree.ooheap.TreeNode): void {
                                this.right = right;
                            }

                            public getParent(): org.kevoree.modeling.api.rbtree.ooheap.TreeNode {
                                return this.parent;
                            }

                            public setParent(parent: org.kevoree.modeling.api.rbtree.ooheap.TreeNode): void {
                                this.parent = parent;
                            }
                            ...
                            public next(): org.kevoree.modeling.api.rbtree.ooheap.TreeNode {
                                var p: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = this;
                                if (p.right != null) {
                                    p = p.right;
                                    while (p.left != null){
                                        p = p.left;
                            ...
                            public previous(): org.kevoree.modeling.api.rbtree.ooheap.TreeNode {
                                var p: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = this;
                                if (p.left != null) {
                                    p = p.left;
                                    while (p.right != null){
                            ...
                            public static unserialize(ctx: org.kevoree.modeling.api.rbtree.ooheap.TreeReaderContext): org.kevoree.modeling.api.rbtree.ooheap.TreeNode {
                                return org.kevoree.modeling.api.rbtree.ooheap.TreeNode.internal_unserialize(true, ctx);
                            }

                            public static internal_unserialize(rightBranch: boolean, ctx: org.kevoree.modeling.api.rbtree.ooheap.TreeReaderContext): org.kevoree.modeling.api.rbtree.ooheap.TreeNode {
                                if (ctx.index >= ctx.payload.length) {
                                    return null;
                                }
                                ...
                                var p: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = new org.kevoree.modeling.api.rbtree.ooheap.TreeNode(java.lang.Long.parseLong(tokenBuild.toString()), colorLoaded, null, null);
                                var left: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = org.kevoree.modeling.api.rbtree.ooheap.TreeNode.internal_unserialize(false, ctx);
                                if (left != null) {
                                    left.setParent(p);
                                }
                                var right: org.kevoree.modeling.api.rbtree.ooheap.TreeNode = org.kevoree.modeling.api.rbtree.ooheap.TreeNode.internal_unserialize(true, ctx);
                                if (right != null) {
                                    right.setParent(p);
                                }
                                p.setLeft(left);
                ...
                export module reflexive {
                    export class DynamicKModel extends org.kevoree.modeling.api.abs.AbstractKModel<any> {
                        ...
                        public internalCreateUniverse(universe: number): org.kevoree.modeling.api.KUniverse<any, any, any> {
                ...
                export module traversal {
                    export class DefaultKTraversal implements org.kevoree.modeling.api.traversal.KTraversal {
                        ...
                        public collect(metaReference: org.kevoree.modeling.api.meta.MetaReference, continueCondition: (p : org.kevoree.modeling.api.KObject) => boolean): org.kevoree.modeling.api.traversal.KTraversal {
                        ...
                        public then(cb: (p : org.kevoree.modeling.api.KObject[]) => void): void {
                        ...
                        public map(attribute: org.kevoree.modeling.api.meta.MetaAttribute, cb: (p : any[]) => void): void {
                    ...
                    export module actions {
                        export class KDeepCollectAction implements org.kevoree.modeling.api.traversal.KTraversalAction {
                            ...
                            private _continueCondition: (p : org.kevoree.modeling.api.KObject) => boolean;
                            ...
                            private executeStep(p_inputStep: org.kevoree.modeling.api.KObject[], private_callback: (p : org.kevoree.modeling.api.KObject[]) => void): void {
                                var currentObject: org.kevoree.modeling.api.abs.AbstractKObject = null;
                                ...
                                for (var i: number = 0; i < p_inputStep.length; i++) {
                                    if (p_inputStep[i] != null) {
                                        try {
                                            ...
                                            var raw: org.kevoree.modeling.api.data.cache.KCacheEntry = loopObj._manager.entry(loopObj, org.kevoree.modeling.api.data.manager.AccessMode.READ);
                                            if (raw != null) {
                                ...
                                currentObject._manager.lookupAllobjects(currentObject.universe(), currentObject.now(), trimmed,  (kObjects : org.kevoree.modeling.api.KObject[]) => {
                        ...
                        export class KTraverseAction implements org.kevoree.modeling.api.traversal.KTraversalAction {
                            ...
                            public execute(p_inputs: org.kevoree.modeling.api.KObject[]): void {
                                if (p_inputs == null || p_inputs.length == 0) {
                                    ...
                                    var currentObject: org.kevoree.modeling.api.abs.AbstractKObject = <org.kevoree.modeling.api.abs.AbstractKObject>p_inputs[0];
                                    var nextIds: org.kevoree.modeling.api.map.LongLongHashMap = new org.kevoree.modeling.api.map.LongLongHashMap(org.kevoree.modeling.api.KConfig.CACHE_INIT_SIZE, org.kevoree.modeling.api.KConfig.CACHE_LOAD_FACTOR);
                                    for (var i: number = 0; i < p_inputs.length; i++) {
                                        try {
                                            var loopObj: org.kevoree.modeling.api.abs.AbstractKObject = <org.kevoree.modeling.api.abs.AbstractKObject>p_inputs[i];
                                            var raw: org.kevoree.modeling.api.data.cache.KCacheEntry = currentObject._manager.entry(loopObj, org.kevoree.modeling.api.data.manager.AccessMode.READ);
                                            if (raw != null) {
                                                if (this._reference == null) {
                                                    for (var j: number = 0; j < loopObj.metaClass().metaReferences().length; j++) {
                                                        var ref: org.kevoree.modeling.api.meta.MetaReference = loopObj.metaClass().metaReferences()[j];
                        ...
                        export class KTraverseQueryAction implements org.kevoree.modeling.api.traversal.KTraversalAction {
                            ...
                            public execute(p_inputs: org.kevoree.modeling.api.KObject[]): void {
                                if (p_inputs == null || p_inputs.length == 0) {
                                    ...
                                    var currentFirstObject: org.kevoree.modeling.api.abs.AbstractKObject = <org.kevoree.modeling.api.abs.AbstractKObject>p_inputs[0];
                                    var nextIds: org.kevoree.modeling.api.map.LongLongHashMap = new org.kevoree.modeling.api.map.LongLongHashMap(org.kevoree.modeling.api.KConfig.CACHE_INIT_SIZE, org.kevoree.modeling.api.KConfig.CACHE_LOAD_FACTOR);
                                    for (var i: number = 0; i < p_inputs.length; i++) {
                                        try {
                                            var loopObj: org.kevoree.modeling.api.abs.AbstractKObject = <org.kevoree.modeling.api.abs.AbstractKObject>p_inputs[i];
                                    ...
                                    currentFirstObject._manager.lookupAllobjects(currentFirstObject.universe(), currentFirstObject.now(), trimmed,  (kObjects : org.kevoree.modeling.api.KObject[]) => {
                                        this._next.execute(kObjects);
                                    });
                                }
                            }
                ...
                export module util {
                    ...
                    export class DefaultOperationManager implements org.kevoree.modeling.api.util.KOperationManager {
                        ...
                        private sendToRemote(source: org.kevoree.modeling.api.KObject, operation: org.kevoree.modeling.api.meta.MetaOperation, param: any[], callback: (p : any) => void): void {
                            ...
                            var contentKey: org.kevoree.modeling.api.data.cache.KContentKey = new org.kevoree.modeling.api.data.cache.KContentKey(source.universe(), source.now(), source.uuid());
                            ...
                            if (operationEvent.type() == org.kevoree.modeling.api.msg.KMessageLoader.OPERATION_RESULT_TYPE) {
                                ...
                                if (operationEvent.type() == org.kevoree.modeling.api.msg.KMessageLoader.OPERATION_CALL_TYPE) {
                                    ...
                                    if (operationCore != null) {
                                        ...
                                        view.lookup(sourceKey.obj,  (kObject : org.kevoree.modeling.api.KObject) => {
                                            if (kObject != null) {
                ...
                export module xmi {
                    ...
                    export class XMIModelLoader {
                        ...
                        public static load(manager: org.kevoree.modeling.api.data.manager.KDataManager, universe: number, time: number, str: string, callback: (p : java.lang.Throwable) => void): void {
                        ...
                        private static deserialize(manager: org.kevoree.modeling.api.data.manager.KDataManager, universe: number, time: number, context: org.kevoree.modeling.api.xmi.XMILoadingContext): void {
                            try {
                                var nsURI: string;
                        ...
                        private static callFactory(manager: org.kevoree.modeling.api.data.manager.KDataManager, universe: number, time: number, ctx: org.kevoree.modeling.api.xmi.XMILoadingContext, objectType: string): org.kevoree.modeling.api.KObject {
                        ...
                        private static loadObject(manager: org.kevoree.modeling.api.data.manager.KDataManager, universe: number, time: number, ctx: org.kevoree.modeling.api.xmi.XMILoadingContext, xmiAddress: string, objectType: string): org.kevoree.modeling.api.KObject {
                            var elementTagName: string = ctx.xmiReader.getLocalName();
                            var modelElem: org.kevoree.modeling.api.KObject = org.kevoree.modeling.api.xmi.XMIModelLoader.callFactory(manager, universe, time, ctx, objectType);
                            if (modelElem == null) {
                            ...
                            while (!done){
                                if (ctx.xmiReader.hasNext()) {
                                    ...
                                    if (tok.equals(org.kevoree.modeling.api.xmi.XmlToken.START_TAG)) {
                                        ...
                                        var containedElement: org.kevoree.modeling.api.KObject = org.kevoree.modeling.api.xmi.XMIModelLoader.loadObject(manager, universe, time, ctx, subElementId, subElemName);
                    ...
                    export class XmiFormat implements org.kevoree.modeling.api.KModelFormat {
