                ...
                export module data {
                    ...
                    export module manager {
                        ...
                        export class DefaultKDataManager implements org.kevoree.modeling.api.data.manager.KDataManager {
                            ...
                            public internal_resolve_universe_time(originView: org.kevoree.modeling.api.KView, uuids: number[], callback: (p : org.kevoree.modeling.api.data.cache.KContentKey[]) => void): void {
                                var tempKeys: org.kevoree.modeling.api.data.cache.KContentKey[] = new Array();
                                for (var i: number = 0; i < uuids.length; i++) {
                                    if (uuids[i] != org.kevoree.modeling.api.KConfig.NULL_LONG) {
                                        tempKeys[i] = org.kevoree.modeling.api.data.cache.KContentKey.createUniverseTree(uuids[i]);
                                    }
                                }
                                this.bumpKeysToCache(tempKeys,  (universeIndexes : org.kevoree.modeling.api.data.cache.KCacheObject[]) => {
                                    for (var i: number = 0; i < uuids.length; i++) {
                                        var toLoadKey: org.kevoree.modeling.api.data.cache.KContentKey = null;
                                        if (universeIndexes[i] != null) {
                                            var closestUniverse: number = org.kevoree.modeling.api.data.manager.ResolutionHelper.resolve_universe(this.globalUniverseOrder(), <org.kevoree.modeling.api.map.LongLongHashMap>universeIndexes[i], originView.now(), originView.universe().key());
                                            toLoadKey = org.kevoree.modeling.api.data.cache.KContentKey.createTimeTree(closestUniverse, uuids[i]);
                                        }
                                        tempKeys[i] = toLoadKey;
                                    }
                                    this.bumpKeysToCache(tempKeys,  (timeIndexes : org.kevoree.modeling.api.data.cache.KCacheObject[]) => {
                                        for (var i: number = 0; i < uuids.length; i++) {
                                            ...
                                            if (timeIndexes[i] != null) {
                                                ...
                                                if (resolvedNode != null) {
                                                    resolvedContentKey = org.kevoree.modeling.api.data.cache.KContentKey.createObject(tempKeys[i].universe(), resolvedNode.getKey(), uuids[i]);
                                                }
                                            }
                                ...
                                if (objectReader.get(org.kevoree.modeling.api.json.JsonModelSerializer.KEY_META) == null) {
                                    ...
                                    for (var i: number = 0; i < metaKeys.length; i++) {
                                        if (metaKeys[i].equals(org.kevoree.modeling.api.json.JsonModelSerializer.INBOUNDS_META)) {
                                            try {
                                                var raw_payload: any = objectReader.get(metaKeys[i]);
                                            ...
                                            if (metaKeys[i].equals(org.kevoree.modeling.api.json.JsonModelSerializer.PARENT_META)) {
                                                try {
                                                    var parentKeyStrings: java.util.ArrayList<string> = <java.util.ArrayList<string>>objectReader.get(metaKeys[i]);
                                                    var parentKey: number[] = new Array();
                        ...
                        export class LookupAllRunnable implements java.lang.Runnable {
                            ...
                            public run(): void {
                                this._store.internal_resolve_universe_time(this._originView, this._keys,  (toLoadContentRaws : org.kevoree.modeling.api.data.cache.KContentKey[]) => {
                                    this._store.bumpKeysToCache(toLoadContentRaws,  (cachedObjects : org.kevoree.modeling.api.data.cache.KCacheObject[]) => {
                            ...
                            if (this._manager != null) {
                                if (param instanceof org.kevoree.modeling.api.msg.KEvents) {
                                    ...
                                    for (var i: number = 0; i < messages.size(); i++) {
                                        var universeLayer: org.kevoree.modeling.api.event.LocalListenerUniverseLayer = this._universeLayers.get(messages.getKey(i).universe());
                                        if (universeLayer != null) {
                                    ...
                                    (<org.kevoree.modeling.api.data.manager.DefaultKDataManager>this._manager).bumpKeysToCache(toLoad,  (kCacheObjects : org.kevoree.modeling.api.data.cache.KCacheObject[]) => {
                                        for (var i: number = 0; i < messages.size(); i++) {
                                            if (kCacheObjects[i] != null && kCacheObjects[i] instanceof org.kevoree.modeling.api.data.cache.KCacheEntry) {
                                                var universeLayer: org.kevoree.modeling.api.event.LocalListenerUniverseLayer = this._universeLayers.get(messages.getKey(i).universe());
                                                if (universeLayer != null) {
                                                    var toDispatch: org.kevoree.modeling.api.KObject = (<org.kevoree.modeling.api.abs.AbstractKView>universeLayer.getUniverse().time(messages.getKey(i).time())).createProxy((<org.kevoree.modeling.api.data.cache.KCacheEntry>kCacheObjects[i]).metaClass, messages.getKey(i).obj());
                            ...
                            try {
                                ...
                                if (parsedType == KMessageLoader.EVENTS_TYPE) {
                                    ...
                                    if (objectReader.get(KMessageLoader.KEYS_NAME) != null) {
                                        var objIdsRaw: java.util.ArrayList<string> = <java.util.ArrayList<string>>objectReader.get(KMessageLoader.KEYS_NAME);
                                        eventsMessage = new org.kevoree.modeling.api.msg.KEvents(objIdsRaw.size());
                                        var keys: org.kevoree.modeling.api.data.cache.KContentKey[] = new Array();
                                        for (var i: number = 0; i < objIdsRaw.size(); i++) {
                                            try {
                                        ...
                                        if (objectReader.get(KMessageLoader.VALUES_NAME) != null) {
                                            var metaInt: java.util.ArrayList<string> = <java.util.ArrayList<string>>objectReader.get(KMessageLoader.VALUES_NAME);
                                            var metaIndexes: number[][] = new Array();
                                            for (var i: number = 0; i < metaInt.size(); i++) {
                                                try {
                                                    if (metaInt.get(i) != null) {
                                                        var splitted: string[] = metaInt.get(i).split("%");
                                    ...
                                    if (parsedType == KMessageLoader.GET_REQ_TYPE) {
                                        ...
                                        if (objectReader.get(KMessageLoader.KEYS_NAME) != null) {
                                            var metaInt: java.util.ArrayList<string> = <java.util.ArrayList<string>>objectReader.get(KMessageLoader.KEYS_NAME);
                                            var keys: org.kevoree.modeling.api.data.cache.KContentKey[] = new Array();
                                            for (var i: number = 0; i < metaInt.size(); i++) {
                                        ...
                                        if (parsedType == KMessageLoader.GET_RES_TYPE) {
                                            ...
                                            if (parsedType == KMessageLoader.PUT_REQ_TYPE) {
                                                ...
                                                if (objectReader.get(KMessageLoader.KEYS_NAME) != null) {
                                                    var metaKeys: java.util.ArrayList<string> = <java.util.ArrayList<string>>objectReader.get(KMessageLoader.KEYS_NAME);
                                                    toFlatKeys = metaKeys.toArray(new Array());
                                                }
                                                if (objectReader.get(KMessageLoader.VALUES_NAME) != null) {
                                                    var metaValues: java.util.ArrayList<string> = <java.util.ArrayList<string>>objectReader.get(KMessageLoader.VALUES_NAME);
                                                ...
                                                if (parsedType == KMessageLoader.PUT_RES_TYPE) {
                                                    ...
                                                    if (parsedType == KMessageLoader.OPERATION_CALL_TYPE) {
                                                        ...
                                                        if (objectReader.get(KMessageLoader.PARAMETERS_NAME) != null) {
                                                            var params: java.util.ArrayList<string> = <java.util.ArrayList<string>>objectReader.get(KMessageLoader.PARAMETERS_NAME);
                    ...
                    export class ModelTraceApplicator {
                        ...
                        public applyTraceSequence(traceSeq: org.kevoree.modeling.api.trace.TraceSequence, callback: (p : java.lang.Throwable) => void): void {
                            try {
                                ...
                                var dependencies: org.kevoree.modeling.api.map.LongLongHashMap = new org.kevoree.modeling.api.map.LongLongHashMap(traces.length * 2, org.kevoree.modeling.api.KConfig.CACHE_LOAD_FACTOR);
                                for (var i: number = 0; i < traces.length; i++) {
                                    if (traces[i] instanceof org.kevoree.modeling.api.trace.ModelAddTrace) {
                                        dependencies.put((<org.kevoree.modeling.api.trace.ModelAddTrace>traces[i]).paramUUID(), (<org.kevoree.modeling.api.trace.ModelAddTrace>traces[i]).paramUUID());
                                    ...
                                    if (traces[i] instanceof org.kevoree.modeling.api.trace.ModelRemoveTrace) {
                                        dependencies.put((<org.kevoree.modeling.api.trace.ModelRemoveTrace>traces[i]).paramUUID(), (<org.kevoree.modeling.api.trace.ModelRemoveTrace>traces[i]).paramUUID());
                                        dependencies.put(traces[i].sourceUUID(), traces[i].sourceUUID());
                                    }
                                ...
                                var trimmed: number[] = new Array();
                                var inserted: number[] = [0];
                                dependencies.each( (key : number, value : number) => {
                                    trimmed[inserted[0]] = key;
                                    inserted[0]++;
                                });
                                this._targetModel.view().lookupAll(trimmed).then( (kObjects : org.kevoree.modeling.api.KObject[]) => {
                ...
                export module traversal {
                    export class DefaultKTraversal implements org.kevoree.modeling.api.traversal.KTraversal {
                        ...
                        public removeDuplicate(): org.kevoree.modeling.api.traversal.KTraversal {
                            ...
                            var tempAction: org.kevoree.modeling.api.traversal.actions.KRemoveDuplicateAction = new org.kevoree.modeling.api.traversal.actions.KRemoveDuplicateAction();
                            this._lastAction.chain(tempAction);
                            this._lastAction = tempAction;
                            return this;
                        }
                        ...
                        public deepTraverse(metaReference: org.kevoree.modeling.api.meta.MetaReference, stopCondition: (p : org.kevoree.modeling.api.KObject) => boolean): org.kevoree.modeling.api.traversal.KTraversal {
                            if (this._terminated) {
                                throw new java.lang.RuntimeException(DefaultKTraversal.TERMINATED_MESSAGE);
                            }
                            var tempAction: org.kevoree.modeling.api.traversal.actions.KDeepTraverseAction = new org.kevoree.modeling.api.traversal.actions.KDeepTraverseAction(metaReference, stopCondition);
                            this._lastAction.chain(tempAction);
                            this._lastAction = tempAction;
                            return this;
                        }

                        public deepCollect(metaReference: org.kevoree.modeling.api.meta.MetaReference, stopCondition: (p : org.kevoree.modeling.api.KObject) => boolean): org.kevoree.modeling.api.traversal.KTraversal {
                            if (this._terminated) {
                                throw new java.lang.RuntimeException(DefaultKTraversal.TERMINATED_MESSAGE);
                            }
                            var tempAction: org.kevoree.modeling.api.traversal.actions.KDeepCollectAction = new org.kevoree.modeling.api.traversal.actions.KDeepCollectAction(metaReference, stopCondition);
                            this._lastAction.chain(tempAction);
                            this._lastAction = tempAction;
                            return this;
                        }
                    ...
                    export interface KTraversal {
                        ...
                        deepTraverse(metaReference: org.kevoree.modeling.api.meta.MetaReference, stopCondition: (p : org.kevoree.modeling.api.KObject) => boolean): org.kevoree.modeling.api.traversal.KTraversal;

                        deepCollect(metaReference: org.kevoree.modeling.api.meta.MetaReference, stopCondition: (p : org.kevoree.modeling.api.KObject) => boolean): org.kevoree.modeling.api.traversal.KTraversal;
                    ...
                    export module actions {
                        export class KDeepCollectAction implements org.kevoree.modeling.api.traversal.KTraversalAction {
                            ...
                            private _reference: org.kevoree.modeling.api.meta.MetaReference;
                            private _stopCondition: (p : org.kevoree.modeling.api.KObject) => boolean;
                            constructor(p_reference: org.kevoree.modeling.api.meta.MetaReference, p_stopCondition: (p : org.kevoree.modeling.api.KObject) => boolean) {
                                this._reference = p_reference;
