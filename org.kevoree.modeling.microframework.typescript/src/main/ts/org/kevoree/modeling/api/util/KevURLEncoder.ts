...
class KevURLEncoder {
  ...
  private static nonEscaped: JUMap<string, boolean> = new JUHashMap<string, boolean>();
  private static escaped: JUHashMap<string, string> = new JUHashMap<string, string>();
  private static rescaped: JUMap<string, string> = new JUHashMap<string, string>();
