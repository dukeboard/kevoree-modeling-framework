...
class DefaultTimeTree implements TimeTree {
  ...
  public walkAsc(walker: TimeWalker): void {
    var elem: Node = this.versionTree.first();
    while (elem != null){
  ...
  public walkDesc(walker: TimeWalker): void {
    var elem: Node = this.versionTree.last();
    while (elem != null){
      walker.walk(elem.getKey());
      elem = elem.previous();
    }
  ...
  public walkRangeAsc(walker: TimeWalker, from: number, to: number): void {
    ...
    var elem: Node = this.versionTree.previousOrEqual(from2);
    while (elem != null){
      walker.walk(elem.getKey());
      elem = elem.next();
      if (elem != null) {
  ...
  public walkRangeDesc(walker: TimeWalker, from: number, to: number): void {
    ...
    var elem: Node = this.versionTree.previousOrEqual(to2);
    while (elem != null){
      walker.walk(elem.getKey());
      elem = elem.previous();
      if (elem != null) {
  ...
  public first(): number {
    var firstNode: Node = this.versionTree.first();
    if (firstNode != null) {
  ...
  public last(): number {
    var lastNode: Node = this.versionTree.last();
    if (lastNode != null) {
  ...
  public next(from: number): number {
    var nextNode: Node = this.versionTree.next(from);
    if (nextNode != null) {
  ...
  public previous(from: number): number {
    var previousNode: Node = this.versionTree.previous(from);
  ...
  public resolve(time: number): number {
    var previousNode: Node = this.versionTree.previousOrEqual(time);
    if (previousNode != null) {
      return previousNode.getKey();
    } else {
      return null;
