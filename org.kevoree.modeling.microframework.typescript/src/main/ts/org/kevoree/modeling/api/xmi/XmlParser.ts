...
class XmlParser {
  ...
  private attributesNames: JUArrayList<string> = new JUArrayList<string>();
  private attributesPrefixes: JUArrayList<string> = new JUArrayList<string>();
  private attributesValues: JUArrayList<string> = new JUArrayList<string>();
