...
class KQuery {
  ...
  public params: JUMap<string, KQueryParam> = null;
  ...
  constructor(relationName: string, params: JUMap<string, KQueryParam>, subQuery: string, oldString: string, previousIsDeep: boolean, previousIsRefDeep: boolean) {
  ...
  public static extractFirstQuery(query: string): KQuery {
    ...
    if (query.charAt(0) == KQuery.QUERY_SEP) {
      ...
      var params: JUMap<string, KQueryParam> = new JUHashMap<string, KQueryParam>();
    ...
    if (i > 0 && relationNameEnd > 0) {
      ...
      var params: JUHashMap<string, KQueryParam> = new JUHashMap<string, KQueryParam>();
