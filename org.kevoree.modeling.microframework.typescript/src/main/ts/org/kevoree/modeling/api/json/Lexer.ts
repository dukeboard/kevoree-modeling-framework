...
class Lexer {
  ...
  private EOF: Token = null;
  private BOOLEAN_LETTERS: HashSet<string> = null;
  private DIGIT: HashSet<string> = null;
  ...
  private isBooleanLetter(c: string): boolean {
    if (this.BOOLEAN_LETTERS == null) {
      this.BOOLEAN_LETTERS = new HashSet<string>();
