                ...
                (function (data) {
                    ...
                    (function (cache) {
                        ...
                        var KCacheEntry = (function () {
                            ...
                            KCacheEntry.prototype.clearRaw = function () {
                                this.raw = null;
                            };
                                            ...
                                            if (error != null) {
                                                ...
                                                for (var i = 0; i < strings.length; i++) {
                                                    if (strings[i] != null) {
                                                        ...
                                                        if (org.kevoree.modeling.api.data.manager.JsonRaw.decode(strings[i], objects[i].resolvedQuanta, _this._originView.universe().model().metaModel(), entry)) {
                                            ...
                                            if (parsedType == KMessageLoader.PUT_REQ_TYPE) {
                                                ...
                                                if (parsedType == KMessageLoader.PUT_RES_TYPE) {
                                                    ...
                                                    if (parsedType == KMessageLoader.OPERATION_CALL_TYPE) {
                                                        ...
                                                        if (content.get(KMessageLoader.VALUES_NAME) != null) {
                                                            var metaParams = content.get(KMessageLoader.VALUES_NAME);
