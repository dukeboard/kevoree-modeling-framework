...
then
	...
	curl http://maven.kevoree.org/archiva/repository/snapshots/org/kevoree/tools/org.kevoree.tools.ui.editor.standalone/2.0.0-SNAPSHOT/org.kevoree.tools.ui.editor.standalone-2.0.0-20130612.145742-328.jar > kevJavaEditor.jar
fi	
