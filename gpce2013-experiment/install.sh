...
then
	...
	curl http://maven.kevoree.org/snapshots/org/kevoree/tools/org.kevoree.tools.ui.editor.standalone/2.0.0-SNAPSHOT/org.kevoree.tools.ui.editor.standalone-2.0.0-20130611.223347-324.jar > kevJavaEditor.jar
fi	
